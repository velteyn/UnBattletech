...
public partial class GeneratedOverrides : CSharpOverrideHelper {
  ...
  public virtual Action split_1000_1005_11005(int loadOffset) {
    ...
    CheckExternalEvents(cs7, 0x1006);
    // POP SI (1000_1005 / 0x11005)
    SI = Stack.Pop16();;
    CheckExternalEvents(cs7, 0x1008);
    // MOV SP,BP (1000_1006 / 0x11006)
    SP = BP;
    CheckExternalEvents(cs7, 0x1009);
    // POP BP (1000_1008 / 0x11008)
    BP = Stack.Pop16();;
    CheckExternalEvents(cs7, 0x100A);
  ...
  public virtual Action ghidra_guess_1000_160E_1160E(int loadOffset) {
    ...
    // SI <<= 0x1;
    SI = Alu.Shl16(SI, 0x1);
    CheckExternalEvents(cs7, 0x16D3);
    ...
    CheckExternalEvents(cs7, 0x16FC);
    ...
    CheckExternalEvents(cs7, 0x1701);
    // SHL BX,0x1 (1000_16FF / 0x116FF)
    // BX <<= 0x1;
    BX = Alu.Shl16(BX, 0x1);
    CheckExternalEvents(cs7, 0x1705);
    ...
    // SI |= SI;
    SI = Alu.Or16(SI, SI);
    CheckExternalEvents(cs7, 0x1709);
    ...
    AX += SI;
    CheckExternalEvents(cs7, 0x1711);
    // AND AX,0x1 (1000_170E / 0x1170E)
    // AX &= 0x1;
    AX = Alu.And16(AX, 0x1);
    CheckExternalEvents(cs7, 0x1714);
    ...
    // AX |= AX;
    AX = Alu.Or16(AX, AX);
    CheckExternalEvents(cs7, 0x1718);
    // JNZ 0x1000:171b (1000_1716 / 0x11716)
    if(!ZeroFlag) {
      goto label_1000_171B_1171B;
    }
    CheckExternalEvents(cs7, 0x171B);
    // ADD word ptr [BP + -0x10],SI (1000_1718 / 0x11718)
    // UInt16[SS, (ushort)(BP - 0x10)] += SI;
    UInt16[SS, (ushort)(BP - 0x10)] = Alu.Add16(UInt16[SS, (ushort)(BP - 0x10)], SI);
    label_1000_171B_1171B:
    CheckExternalEvents(cs7, 0x171E);
    // MOV SI,word ptr [BP + -0x12] (1000_171B / 0x1171B)
    SI = UInt16[SS, (ushort)(BP - 0x12)];
    CheckExternalEvents(cs7, 0x1720);
    // SHL SI,0x1 (1000_171E / 0x1171E)
    SI <<= 0x1;
    CheckExternalEvents(cs7, 0x1725);
    // CMP word ptr [SI + 0x329a],0x0 (1000_1720 / 0x11720)
    Alu.Sub16(UInt16[DS, (ushort)(SI + 0x329A)], 0x0);
    CheckExternalEvents(cs7, 0x1727);
    ...
    AX = UInt16[DS, (ushort)(SI + 0x329A)];
    CheckExternalEvents(cs7, 0x172E);
    ...
    UInt16[SS, (ushort)(BP - 0x2)] = AX;
    CheckExternalEvents(cs7, 0x1736);
    // OR AX,AX (1000_1734 / 0x11734)
    // AX |= AX;
    AX = Alu.Or16(AX, AX);
    CheckExternalEvents(cs7, 0x1738);
    ...
    CheckExternalEvents(cs7, 0x1742);
    // MOV BX,word ptr [BP + -0x10] (1000_173F / 0x1173F)
    BX = UInt16[SS, (ushort)(BP - 0x10)];
    CheckExternalEvents(cs7, 0x1746);
    // MOV ES,word ptr [0x5588] (1000_1742 / 0x11742)
    ES = UInt16[DS, 0x5588];
    CheckExternalEvents(cs7, 0x174B);
    ...
    CheckExternalEvents(cs7, 0x176F);
    // MOV AX,word ptr [BP + 0xa] (1000_176C / 0x1176C)
    AX = UInt16[SS, (ushort)(BP + 0xA)];
    CheckExternalEvents(cs7, 0x1772);
    ...
    CheckExternalEvents(cs7, 0x1777);
    ...
    CheckExternalEvents(cs7, 0x17B6);
    ...
    SI = Stack.Pop16();;
    CheckExternalEvents(cs7, 0x17B9);
    // MOV SP,BP (1000_17B7 / 0x117B7)
    SP = BP;
    CheckExternalEvents(cs7, 0x17BA);
  ...
  public virtual Action ghidra_guess_1000_17BB_117BB(int loadOffset) {
    ...
    CheckExternalEvents(cs7, 0x17BC);
    ...
    // AX ^= AX;
    AX = Alu.Xor16(AX, AX);
    CheckExternalEvents(cs7, 0x17C5);
    // CALLF 0x1000:cecc (1000_17C0 / 0x117C0)
    FarCall(cs7, 0x17C5, unknown_19EF_2FDC_1CECC);
    CheckExternalEvents(cs7, 0x17CA);
    // CMP word ptr [0x2e38],0x0 (1000_17C5 / 0x117C5)
    Alu.Sub16(UInt16[DS, 0x2E38], 0x0);
    ...
    Stack.Push16(UInt16[SS, (ushort)(BP + 0x8)]);
    CheckExternalEvents(cs7, 0x17D2);
  ...
  public virtual Action ghidra_guess_1000_17DC_117DC(int loadOffset) {
    ...
    CheckExternalEvents(cs7, 0x17DE);
    // XOR AX,AX (1000_17DC / 0x117DC)
    // AX ^= AX;
    AX = Alu.Xor16(AX, AX);
    CheckExternalEvents(cs7, 0x17E3);
    // CALLF 0x1000:cecc (1000_17DE / 0x117DE)
    FarCall(cs7, 0x17E3, unknown_19EF_2FDC_1CECC);
    ...
    Alu.Sub16(UInt16[ES, 0x15E], 0x5);
    CheckExternalEvents(cs7, 0x17EF);
    // JGE 0x1000:1802 (1000_17ED / 0x117ED)
    if(SignFlag == OverflowFlag) {
      goto label_1000_1802_11802;
    }
    CheckExternalEvents(cs7, 0x17F2);
    // MOV AX,0xc (1000_17EF / 0x117EF)
    AX = 0xC;
    CheckExternalEvents(cs7, 0x17F7);
    // IMUL word ptr ES:[0x15e] (1000_17F2 / 0x117F2)
    int resImul1000_17F2 = Alu.Imul16((short)AX, (short)UInt16[ES, 0x15E]);
    ...
    FarCall(cs7, 0x17FD, unknown_18AD_0006_18AD6);
    ...
    CheckExternalEvents(cs7, 0x1808);
    // RETF  (1000_1807 / 0x11807)
    return FarRet();
    label_1000_1802_11802:
    CheckExternalEvents(cs7, 0x1807);
    // CALLF 0x1000:8d29 (1000_1802 / 0x11802)
    FarCall(cs7, 0x1807, unknown_18AD_0259_18D29);
  ...
  public virtual Action ghidra_guess_1000_1808_11808(int loadOffset) {
    ...
    UInt16[SS, (ushort)(BP + 0x8)] = Alu.Dec16(UInt16[SS, (ushort)(BP + 0x8)]);
    CheckExternalEvents(cs7, 0x1830);
    // MOV AL,byte ptr [BP + 0x8] (1000_182D / 0x1182D)
    AL = UInt8[SS, (ushort)(BP + 0x8)];
    CheckExternalEvents(cs7, 0x1832);
    ...
    AL = UInt8[SS, (ushort)(BP + 0x8)];
    CheckExternalEvents(cs7, 0x1854);
    ...
    CheckExternalEvents(cs7, 0x186E);
    // JMP 0x1000:1886 (1000_186C / 0x1186C)
    goto label_1000_1886_11886;
    label_1000_186E_1186E:
    CheckExternalEvents(cs7, 0x1871);
    // DEC word ptr [BP + 0x6] (1000_186E / 0x1186E)
    UInt16[SS, (ushort)(BP + 0x6)] = Alu.Dec16(UInt16[SS, (ushort)(BP + 0x6)]);
    ...
    CheckExternalEvents(cs7, 0x1890);
    ...
    AL = UInt8[SS, (ushort)(BP + 0x6)];
    CheckExternalEvents(cs7, 0x1898);
    ...
    CheckExternalEvents(cs7, 0x189F);
    // ADD word ptr [BP + 0x6],0x80 (1000_189A / 0x1189A)
    // UInt16[SS, (ushort)(BP + 0x6)] += 0x80;
    UInt16[SS, (ushort)(BP + 0x6)] = Alu.Add16(UInt16[SS, (ushort)(BP + 0x6)], 0x80);
  ...
  public virtual Action ghidra_guess_1000_18B2_118B2(int loadOffset) {
    ...
    CheckExternalEvents(cs7, 0x18B3);
    // PUSH BP (1000_18B2 / 0x118B2)
    Stack.Push16(BP);
    CheckExternalEvents(cs7, 0x18B5);
    // MOV BP,SP (1000_18B3 / 0x118B3)
    BP = SP;
    CheckExternalEvents(cs7, 0x18B8);
    // MOV AX,0x2 (1000_18B5 / 0x118B5)
    AX = 0x2;
    CheckExternalEvents(cs7, 0x18BD);
    // CALLF 0x1000:cecc (1000_18B8 / 0x118B8)
    FarCall(cs7, 0x18BD, unknown_19EF_2FDC_1CECC);
    CheckExternalEvents(cs7, 0x18C1);
    ...
    CheckExternalEvents(cs7, 0x18C9);
    ...
    CheckExternalEvents(cs7, 0x18D1);
    // MOV AX,word ptr [BP + 0x6] (1000_18CE / 0x118CE)
    AX = UInt16[SS, (ushort)(BP + 0x6)];
    CheckExternalEvents(cs7, 0x18D3);
    // NEG AX (1000_18D1 / 0x118D1)
    AX = Alu.Sub16(0, AX);
    CheckExternalEvents(cs7, 0x18D6);
    ...
    CheckExternalEvents(cs7, 0x18DA);
    ...
    AX = Alu.Sub16(0, AX);
    CheckExternalEvents(cs7, 0x190D);
  ...
  public virtual Action ghidra_guess_1000_1919_11919(int loadOffset) {
    ...
    CheckExternalEvents(cs7, 0x191A);
    // PUSH BP (1000_1919 / 0x11919)
    Stack.Push16(BP);
    CheckExternalEvents(cs7, 0x191C);
    // MOV BP,SP (1000_191A / 0x1191A)
    BP = SP;
    CheckExternalEvents(cs7, 0x191F);
    // MOV AX,0x2 (1000_191C / 0x1191C)
    AX = 0x2;
    CheckExternalEvents(cs7, 0x1924);
    // CALLF 0x1000:cecc (1000_191F / 0x1191F)
    FarCall(cs7, 0x1924, unknown_19EF_2FDC_1CECC);
    CheckExternalEvents(cs7, 0x1925);
    // PUSH SI (1000_1924 / 0x11924)
    Stack.Push16(SI);
    CheckExternalEvents(cs7, 0x1928);
    ...
    Stack.Push16(UInt16[SS, (ushort)(BP + 0x8)]);
    CheckExternalEvents(cs7, 0x192F);
    // PUSH word ptr [BP + 0x6] (1000_192C / 0x1192C)
    Stack.Push16(UInt16[SS, (ushort)(BP + 0x6)]);
    CheckExternalEvents(cs7, 0x1934);
    // CALLF 0x1000:bdbe (1000_192F / 0x1192F)
    FarCall(cs7, 0x1934, ghidra_guess_1000_BDBE_1BDBE);
    ...
    UInt16[SS, (ushort)(BP - 0x2)] = 0x4;
    CheckExternalEvents(cs7, 0x1940);
    // MOV ES,word ptr [0x558e] (1000_193C / 0x1193C)
    ES = UInt16[DS, 0x558E];
    CheckExternalEvents(cs7, 0x1946);
    // CMP byte ptr ES:[0xc620],0x8 (1000_1940 / 0x11940)
    Alu.Sub8(UInt8[ES, 0xC620], 0x8);
    CheckExternalEvents(cs7, 0x1948);
    ...
    AL = UInt8[ES, 0xC620];
    CheckExternalEvents(cs7, 0x194D);
    ...
    FarCall(cs7, 0x1974, unknown_0170_240B_03B0B);
    CheckExternalEvents(cs7, 0x1979);
    // CALLF 0x1000:b7df (1000_1974 / 0x11974)
    FarCall(cs7, 0x1979, unknown_19EF_18EF_1B7DF);
    CheckExternalEvents(cs7, 0x197E);
    // CALLF 0x0000:254b (1000_1979 / 0x11979)
    FarCall(cs7, 0x197E, ghidra_guess_0000_254B_0254B);
    CheckExternalEvents(cs7, 0x197F);
    // POP SI (1000_197E / 0x1197E)
    SI = Stack.Pop16();;
    CheckExternalEvents(cs7, 0x1981);
    // MOV SP,BP (1000_197F / 0x1197F)
    SP = BP;
    CheckExternalEvents(cs7, 0x1982);
    // POP BP (1000_1981 / 0x11981)
    BP = Stack.Pop16();;
    CheckExternalEvents(cs7, 0x1983);
  ...
  public virtual Action ghidra_guess_1000_1983_11983(int loadOffset) {
    ...
    Stack.Push16(BP);
    CheckExternalEvents(cs7, 0x1986);
    // MOV BP,SP (1000_1984 / 0x11984)
    BP = SP;
    CheckExternalEvents(cs7, 0x1988);
    // XOR AX,AX (1000_1986 / 0x11986)
    // AX ^= AX;
    AX = Alu.Xor16(AX, AX);
    CheckExternalEvents(cs7, 0x198D);
    // CALLF 0x1000:cecc (1000_1988 / 0x11988)
    FarCall(cs7, 0x198D, unknown_19EF_2FDC_1CECC);
    CheckExternalEvents(cs7, 0x1991);
    // MOV ES,word ptr [0x55be] (1000_198D / 0x1198D)
    ES = UInt16[DS, 0x55BE];
    CheckExternalEvents(cs7, 0x1997);
    ...
    // BX <<= 0x1;
    BX = Alu.Shl16(BX, 0x1);
    CheckExternalEvents(cs7, 0x19AA);
    ...
    CheckExternalEvents(cs7, 0x19B4);
    ...
    AX = 0x244B;
    CheckExternalEvents(cs7, 0x19BA);
    // MOV DX,0x1ddc (1000_19B7 / 0x119B7)
    DX = 0x1DDC;
    CheckExternalEvents(cs7, 0x19BB);
    // PUSH DX (1000_19BA / 0x119BA)
    Stack.Push16(DX);
    CheckExternalEvents(cs7, 0x19BC);
    // PUSH AX (1000_19BB / 0x119BB)
    Stack.Push16(AX);
    CheckExternalEvents(cs7, 0x19C1);
    // CALLF 0x1000:c7db (1000_19BC / 0x119BC)
    FarCall(cs7, 0x19C1, unknown_19EF_28EB_1C7DB);
    CheckExternalEvents(cs7, 0x19C3);
    ...
    Stack.Push16(UInt16[SS, (ushort)(BP + 0x8)]);
    CheckExternalEvents(cs7, 0x19CC);
    // MOV BX,word ptr [BP + 0x6] (1000_19C9 / 0x119C9)
    BX = UInt16[SS, (ushort)(BP + 0x6)];
    CheckExternalEvents(cs7, 0x19CE);
    ...
    // BX <<= 0x1;
    BX = Alu.Shl16(BX, 0x1);
    CheckExternalEvents(cs7, 0x19D4);
    ...
    Stack.Push16(UInt16[ES, (ushort)(BX + 0x39FA)]);
    CheckExternalEvents(cs7, 0x19E0);
    // SUB AX,AX (1000_19DE / 0x119DE)
    // AX -= AX;
    AX = Alu.Sub16(AX, AX);
    CheckExternalEvents(cs7, 0x19E3);
    // MOV DX,0xac00 (1000_19E0 / 0x119E0)
    DX = 0xAC00;
    CheckExternalEvents(cs7, 0x19E4);
    // PUSH DX (1000_19E3 / 0x119E3)
    Stack.Push16(DX);
    CheckExternalEvents(cs7, 0x19E5);
    // PUSH AX (1000_19E4 / 0x119E4)
    Stack.Push16(AX);
    CheckExternalEvents(cs7, 0x19EA);
    // CALLF 0x1000:a267 (1000_19E5 / 0x119E5)
    FarCall(cs7, 0x19EA, ghidra_guess_1000_A267_1A267);
    label_1000_19EA_119EA:
    CheckExternalEvents(cs7, 0x19ED);
    ...
    BP = Stack.Pop16();;
    CheckExternalEvents(cs7, 0x19EF);
  ...
  public virtual Action ghidra_guess_1000_1ABA_11ABA(int loadOffset) {
    ...
    CheckExternalEvents(cs7, 0x1AF4);
    // MOV ES,word ptr [0x55d0] (1000_1AF0 / 0x11AF0)
    ES = UInt16[DS, 0x55D0];
    CheckExternalEvents(cs7, 0x1AF9);
    ...
    CheckExternalEvents(cs7, 0x1B10);
    ...
    CheckExternalEvents(cs7, 0x1B3A);
    ...
    CheckExternalEvents(cs7, 0x1FF3);
    // CALLF 0x0000:412b (1000_1FEE / 0x11FEE)
    FarCall(cs7, 0x1FF3, unknown_0170_2A2B_0412B);
    CheckExternalEvents(cs7, 0x1FF4);
    // PUSH CS (1000_1FF3 / 0x11FF3)
    Stack.Push16(cs7);
    CheckExternalEvents(cs7, 0x1FF7);
    // CALL 0x1000:3fa0 (1000_1FF4 / 0x11FF4)
    NearCall(cs7, 0x1FF7, ghidra_guess_1000_3FA0_13FA0);
    CheckExternalEvents(cs7, 0x1FFB);
    // MOV ES,word ptr [0x55f4] (1000_1FF7 / 0x11FF7)
    ES = UInt16[DS, 0x55F4];
    CheckExternalEvents(cs7, 0x1FFF);
    // MOV ES:[0x2e38],AX (1000_1FFB / 0x11FFB)
    UInt16[ES, 0x2E38] = AX;
    CheckExternalEvents(cs7, 0x2004);
    // CALLF 0x0000:412b (1000_1FFF / 0x11FFF)
    FarCall(cs7, 0x2004, unknown_0170_2A2B_0412B);
    CheckExternalEvents(cs7, 0x2005);
    // PUSH CS (1000_2004 / 0x12004)
    Stack.Push16(cs7);
    CheckExternalEvents(cs7, 0x2008);
    // CALL 0x1000:4006 (1000_2005 / 0x12005)
    NearCall(cs7, 0x2008, ghidra_guess_1000_4006_14006);
    ...
    CheckExternalEvents(cs7, 0x2050);
    ...
    CheckExternalEvents(cs7, 0x207C);
    // MOV BX,word ptr [BP + -0x2c] (1000_2079 / 0x12079)
    BX = UInt16[SS, (ushort)(BP - 0x2C)];
    CheckExternalEvents(cs7, 0x207E);
    // SHL BX,0x1 (1000_207C / 0x1207C)
    // BX <<= 0x1;
    BX = Alu.Shl16(BX, 0x1);
    CheckExternalEvents(cs7, 0x2082);
