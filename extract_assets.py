...
def main():
    ...
    files = [
        "BTTITLE.CMP", "INFOCOM.CMP", "MECHSHAP.CMP", "BTBORDER.CMP", 
        "TINYLAND.CMP", "BTSTATS.CMP", "ENDMECH.CMP",
        "BTTLTECH.ICN", "ANIMATE.ICN", "STARLEAG.ICN", "DESTRUCT.ICN", "MAP.ICN"
    ]
    
    for f in files:
        if os.path.exists(f):
            extractor.extract_file(f)
        else:
