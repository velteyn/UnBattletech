...
public partial class CombatHUD : Control
{
    ...
    public override void _Ready()
    {
        ...
        _statusLabel.Position = new Vector2(4, 2);
        _statusLabel.Theme = theme;
        _statusLabel.Text = "";
        _statusLabel.HorizontalAlignment = HorizontalAlignment.Center;
        _statusLabel.Size = new Vector2(76, 16);
        AddChild(_statusLabel);

        _unitInfoLabel = new Label();
        _unitInfoLabel.Position = new Vector2(4, 20);
        _unitInfoLabel.Theme = theme;
        _unitInfoLabel.Text = "";
        _unitInfoLabel.Size = new Vector2(76, 60);
        AddChild(_unitInfoLabel);

        _weaponListLabel = new Label();
        _weaponListLabel.Position = new Vector2(4, 80);
        _weaponListLabel.Theme = theme;
        _weaponListLabel.Text = "";
        _weaponListLabel.Size = new Vector2(76, 50);
        _weaponListLabel.AutowrapMode = TextServer.AutowrapMode.Off;
        AddChild(_weaponListLabel);

        _logLabel = new RichTextLabel();
        _logLabel.Position = new Vector2(4, 150);
        _logLabel.Size = new Vector2(76, 30);
