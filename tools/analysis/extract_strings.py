...
if __name__ == "__main__":
    input_file = os.path.join(repo_root, "reko", "segments", "UNBTECH_3EDB_0000.asm")
    output_file = os.path.join(repo_root, "java_project", "src", "main", "java", "com", "btech", "GameStrings.java")
