...
public partial class GeneratedOverrides : CSharpOverrideHelper {
  ...
  public virtual Action ghidra_guess_1000_33EB_133EB(int loadOffset) {
    ...
    CheckExternalEvents(cs8, 0x33EC);
    // PUSH BP (1000_33EB / 0x133EB)
    Stack.Push16(BP);
    CheckExternalEvents(cs8, 0x33EE);
    // MOV BP,SP (1000_33EC / 0x133EC)
    BP = SP;
    CheckExternalEvents(cs8, 0x33F1);
    // MOV AX,0x2a (1000_33EE / 0x133EE)
    AX = 0x2A;
    CheckExternalEvents(cs8, 0x33F6);
    // CALLF 0x1000:cecc (1000_33F1 / 0x133F1)
    FarCall(cs8, 0x33F6, unknown_19EF_2FDC_1CECC);
    CheckExternalEvents(cs8, 0x33F7);
    // PUSH DI (1000_33F6 / 0x133F6)
    Stack.Push16(DI);
    CheckExternalEvents(cs8, 0x33F8);
    // PUSH SI (1000_33F7 / 0x133F7)
    Stack.Push16(SI);
    CheckExternalEvents(cs8, 0x33FD);
    // MOV word ptr [BP + -0x20],0x0 (1000_33F8 / 0x133F8)
    UInt16[SS, (ushort)(BP - 0x20)] = 0x0;
    label_1000_33FD_133FD:
    CheckExternalEvents(cs8, 0x3400);
    // MOV AX,0x18 (1000_33FD / 0x133FD)
    AX = 0x18;
    CheckExternalEvents(cs8, 0x3403);
    ...
    CheckExternalEvents(cs8, 0x35A6);
    // MOV AX,0x18 (1000_35A3 / 0x135A3)
    AX = 0x18;
    CheckExternalEvents(cs8, 0x35A9);
  ...
  public virtual Action ghidra_guess_1000_36CF_136CF(int loadOffset) {
    ...
    CheckExternalEvents(cs8, 0x3768);
    // MOV BX,AX (1000_3766 / 0x13766)
    BX = AX;
    CheckExternalEvents(cs8, 0x376C);
    // MOV ES,word ptr [0x55d4] (1000_3768 / 0x13768)
    ES = UInt16[DS, 0x55D4];
    CheckExternalEvents(cs8, 0x3772);
    // CMP byte ptr ES:[BX + 0xc756],0x0 (1000_376C / 0x1376C)
    Alu8.Sub(UInt8[ES, (ushort)(BX + 0xC756)], 0x0);
    CheckExternalEvents(cs8, 0x3774);
    // JNZ 0x1000:3777 (1000_3772 / 0x13772)
    if(!ZeroFlag) {
      goto label_1000_3777_13777;
    }
    CheckExternalEvents(cs8, 0x3777);
    // JMP 0x1000:389a (1000_3774 / 0x13774)
    goto label_1000_389A_1389A;
    label_1000_3777_13777:
    CheckExternalEvents(cs8, 0x377A);
    // MOV AX,word ptr [BP + 0x8] (1000_3777 / 0x13777)
    AX = UInt16[SS, (ushort)(BP + 0x8)];
    CheckExternalEvents(cs8, 0x377D);
    // CMP word ptr [BP + -0xe],AX (1000_377A / 0x1377A)
    Alu16.Sub(UInt16[SS, (ushort)(BP - 0xE)], AX);
    CheckExternalEvents(cs8, 0x377F);
    // JNZ 0x1000:3782 (1000_377D / 0x1377D)
    if(!ZeroFlag) {
      goto label_1000_3782_13782;
    }
    CheckExternalEvents(cs8, 0x3782);
    // JMP 0x1000:389a (1000_377F / 0x1377F)
    goto label_1000_389A_1389A;
    label_1000_3782_13782:
    CheckExternalEvents(cs8, 0x3785);
    // DEC word ptr [BP + -0xc] (1000_3782 / 0x13782)
    UInt16[SS, (ushort)(BP - 0xC)] = Alu16.Dec(UInt16[SS, (ushort)(BP - 0xC)]);
    CheckExternalEvents(cs8, 0x3788);
    // MOV AX,0x4 (1000_3785 / 0x13785)
    AX = 0x4;
    CheckExternalEvents(cs8, 0x3789);
    // PUSH AX (1000_3788 / 0x13788)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x378E);
    // CALLF 0x1000:7ee1 (1000_3789 / 0x13789)
    FarCall(cs8, 0x378E, unknown_17C6_0281_17EE1);
    CheckExternalEvents(cs8, 0x3791);
    // ADD SP,0x2 (1000_378E / 0x1378E)
    // SP += 0x2;
    SP = Alu16.Add(SP, 0x2);
    CheckExternalEvents(cs8, 0x3796);
    // CALLF 0x1000:7fe8 (1000_3791 / 0x13791)
    FarCall(cs8, 0x3796, unknown_17C6_0388_17FE8);
    CheckExternalEvents(cs8, 0x3799);
    // MOV AX,0x3b24 (1000_3796 / 0x13796)
    AX = 0x3B24;
    CheckExternalEvents(cs8, 0x379A);
    // PUSH DS (1000_3799 / 0x13799)
    Stack.Push16(DS);
    CheckExternalEvents(cs8, 0x379B);
    // PUSH AX (1000_379A / 0x1379A)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x37A0);
    // CALLF 0x1000:8055 (1000_379B / 0x1379B)
    FarCall(cs8, 0x37A0, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs8, 0x37A3);
    // ADD SP,0x4 (1000_37A0 / 0x137A0)
    // SP += 0x4;
    SP = Alu16.Add(SP, 0x4);
    CheckExternalEvents(cs8, 0x37A6);
    // MOV BX,word ptr [BP + -0xe] (1000_37A3 / 0x137A3)
    BX = UInt16[SS, (ushort)(BP - 0xE)];
    CheckExternalEvents(cs8, 0x37A8);
    // SHL BX,0x1 (1000_37A6 / 0x137A6)
    BX <<= 0x1;
    CheckExternalEvents(cs8, 0x37AA);
    // SHL BX,0x1 (1000_37A8 / 0x137A8)
    // BX <<= 0x1;
    BX = Alu16.Shl(BX, 0x1);
    CheckExternalEvents(cs8, 0x37AE);
    // PUSH word ptr [BX + 0x3cd6] (1000_37AA / 0x137AA)
    Stack.Push16(UInt16[DS, (ushort)(BX + 0x3CD6)]);
    CheckExternalEvents(cs8, 0x37B2);
    // PUSH word ptr [BX + 0x3cd4] (1000_37AE / 0x137AE)
    Stack.Push16(UInt16[DS, (ushort)(BX + 0x3CD4)]);
    CheckExternalEvents(cs8, 0x37B5);
    // MOV AX,0x12 (1000_37B2 / 0x137B2)
    AX = 0x12;
    CheckExternalEvents(cs8, 0x37B8);
    // MOV DX,0x2a02 (1000_37B5 / 0x137B5)
    DX = 0x2A02;
    CheckExternalEvents(cs8, 0x37B9);
    // PUSH DX (1000_37B8 / 0x137B8)
    Stack.Push16(DX);
    CheckExternalEvents(cs8, 0x37BA);
    // PUSH AX (1000_37B9 / 0x137B9)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x37BF);
    // CALLF 0x1000:da58 (1000_37BA / 0x137BA)
    FarCall(cs8, 0x37BF, unknown_19EF_3B68_1DA58);
    CheckExternalEvents(cs8, 0x37C2);
    // ADD SP,0x8 (1000_37BF / 0x137BF)
    SP += 0x8;
    CheckExternalEvents(cs8, 0x37C6);
    // CMP word ptr [BP + -0xe],0x1 (1000_37C2 / 0x137C2)
    Alu16.Sub(UInt16[SS, (ushort)(BP - 0xE)], 0x1);
    CheckExternalEvents(cs8, 0x37C8);
    // JNZ 0x1000:37dd (1000_37C6 / 0x137C6)
    if(!ZeroFlag) {
      goto label_1000_37DD_137DD;
    }
    CheckExternalEvents(cs8, 0x37CB);
    // MOV AX,0x3b36 (1000_37C8 / 0x137C8)
    AX = 0x3B36;
    CheckExternalEvents(cs8, 0x37CC);
    // PUSH DS (1000_37CB / 0x137CB)
    Stack.Push16(DS);
    CheckExternalEvents(cs8, 0x37CD);
    // PUSH AX (1000_37CC / 0x137CC)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x37D0);
    // MOV AX,0x12 (1000_37CD / 0x137CD)
    AX = 0x12;
    CheckExternalEvents(cs8, 0x37D3);
    // MOV DX,0x2a02 (1000_37D0 / 0x137D0)
    DX = 0x2A02;
    CheckExternalEvents(cs8, 0x37D4);
    // PUSH DX (1000_37D3 / 0x137D3)
    Stack.Push16(DX);
    CheckExternalEvents(cs8, 0x37D5);
    // PUSH AX (1000_37D4 / 0x137D4)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x37DA);
    // CALLF 0x1000:da12 (1000_37D5 / 0x137D5)
    FarCall(cs8, 0x37DA, unknown_19EF_3B22_1DA12);
    CheckExternalEvents(cs8, 0x37DD);
    // ADD SP,0x8 (1000_37DA / 0x137DA)
    // SP += 0x8;
    SP = Alu16.Add(SP, 0x8);
    label_1000_37DD_137DD:
    CheckExternalEvents(cs8, 0x37E0);
    // MOV AX,0x3b38 (1000_37DD / 0x137DD)
    AX = 0x3B38;
    CheckExternalEvents(cs8, 0x37E1);
    // PUSH DS (1000_37E0 / 0x137E0)
    Stack.Push16(DS);
    CheckExternalEvents(cs8, 0x37E2);
    // PUSH AX (1000_37E1 / 0x137E1)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x37E5);
    // MOV AX,0x12 (1000_37E2 / 0x137E2)
    AX = 0x12;
    CheckExternalEvents(cs8, 0x37E8);
    // MOV DX,0x2a02 (1000_37E5 / 0x137E5)
    DX = 0x2A02;
    CheckExternalEvents(cs8, 0x37E9);
    // PUSH DX (1000_37E8 / 0x137E8)
    Stack.Push16(DX);
    CheckExternalEvents(cs8, 0x37EA);
    // PUSH AX (1000_37E9 / 0x137E9)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x37EF);
    // CALLF 0x1000:da12 (1000_37EA / 0x137EA)
    FarCall(cs8, 0x37EF, unknown_19EF_3B22_1DA12);
    CheckExternalEvents(cs8, 0x37F2);
    // ADD SP,0x8 (1000_37EF / 0x137EF)
    // SP += 0x8;
    SP = Alu16.Add(SP, 0x8);
    CheckExternalEvents(cs8, 0x37F5);
    // MOV AX,0x12 (1000_37F2 / 0x137F2)
    AX = 0x12;
    CheckExternalEvents(cs8, 0x37F8);
    // MOV DX,0x2a02 (1000_37F5 / 0x137F5)
    DX = 0x2A02;
    CheckExternalEvents(cs8, 0x37F9);
    // PUSH DX (1000_37F8 / 0x137F8)
    Stack.Push16(DX);
    CheckExternalEvents(cs8, 0x37FA);
    // PUSH AX (1000_37F9 / 0x137F9)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x37FF);
    // CALLF 0x1000:8055 (1000_37FA / 0x137FA)
    FarCall(cs8, 0x37FF, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs8, 0x3802);
    // ADD SP,0x4 (1000_37FF / 0x137FF)
    // SP += 0x4;
    SP = Alu16.Add(SP, 0x4);
    CheckExternalEvents(cs8, 0x3805);
    // MOV AX,0x3b3d (1000_3802 / 0x13802)
    AX = 0x3B3D;
    CheckExternalEvents(cs8, 0x3806);
    // PUSH DS (1000_3805 / 0x13805)
    Stack.Push16(DS);
    CheckExternalEvents(cs8, 0x3807);
    // PUSH AX (1000_3806 / 0x13806)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x380C);
    // CALLF 0x1000:8055 (1000_3807 / 0x13807)
    FarCall(cs8, 0x380C, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs8, 0x380F);
    // ADD SP,0x4 (1000_380C / 0x1380C)
    // SP += 0x4;
    SP = Alu16.Add(SP, 0x4);
    CheckExternalEvents(cs8, 0x3812);
    // MOV BX,word ptr [BP + 0x8] (1000_380F / 0x1380F)
    BX = UInt16[SS, (ushort)(BP + 0x8)];
    CheckExternalEvents(cs8, 0x3814);
    // SHL BX,0x1 (1000_3812 / 0x13812)
    BX <<= 0x1;
    CheckExternalEvents(cs8, 0x3816);
    // SHL BX,0x1 (1000_3814 / 0x13814)
    // BX <<= 0x1;
    BX = Alu16.Shl(BX, 0x1);
    CheckExternalEvents(cs8, 0x381A);
    // PUSH word ptr [BX + 0x3cd6] (1000_3816 / 0x13816)
    Stack.Push16(UInt16[DS, (ushort)(BX + 0x3CD6)]);
    CheckExternalEvents(cs8, 0x381E);
    // PUSH word ptr [BX + 0x3cd4] (1000_381A / 0x1381A)
    Stack.Push16(UInt16[DS, (ushort)(BX + 0x3CD4)]);
    CheckExternalEvents(cs8, 0x3823);
    // CALLF 0x1000:8055 (1000_381E / 0x1381E)
    FarCall(cs8, 0x3823, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs8, 0x3826);
    // ADD SP,0x4 (1000_3823 / 0x13823)
    // SP += 0x4;
    SP = Alu16.Add(SP, 0x4);
    CheckExternalEvents(cs8, 0x3829);
    // MOV AX,0x3b4e (1000_3826 / 0x13826)
    AX = 0x3B4E;
    CheckExternalEvents(cs8, 0x382A);
    // PUSH DS (1000_3829 / 0x13829)
    Stack.Push16(DS);
    CheckExternalEvents(cs8, 0x382B);
    // PUSH AX (1000_382A / 0x1382A)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x3830);
    // CALLF 0x1000:8055 (1000_382B / 0x1382B)
    FarCall(cs8, 0x3830, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs8, 0x3833);
    // ADD SP,0x4 (1000_3830 / 0x13830)
    // SP += 0x4;
    SP = Alu16.Add(SP, 0x4);
    CheckExternalEvents(cs8, 0x3836);
    // MOV AX,0x1 (1000_3833 / 0x13833)
    AX = 0x1;
    CheckExternalEvents(cs8, 0x3837);
    // PUSH AX (1000_3836 / 0x13836)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x383C);
    // CALLF 0x0000:3113 (1000_3837 / 0x13837)
    FarCall(cs8, 0x383C, unknown_0170_1A13_03113);
    CheckExternalEvents(cs8, 0x383F);
    // ADD SP,0x2 (1000_383C / 0x1383C)
    // SP += 0x2;
    SP = Alu16.Add(SP, 0x2);
    CheckExternalEvents(cs8, 0x3841);
    // OR AX,AX (1000_383F / 0x1383F)
    // AX |= AX;
    AX = Alu16.Or(AX, AX);
    CheckExternalEvents(cs8, 0x3843);
    // JZ 0x1000:389a (1000_3841 / 0x13841)
    if(ZeroFlag) {
      goto label_1000_389A_1389A;
    }
    CheckExternalEvents(cs8, 0x3846);
    // INC word ptr [BP + -0xc] (1000_3843 / 0x13843)
    UInt16[SS, (ushort)(BP - 0xC)] = Alu16.Inc(UInt16[SS, (ushort)(BP - 0xC)]);
    CheckExternalEvents(cs8, 0x384B);
    // CALLF 0x1000:7fe8 (1000_3846 / 0x13846)
    FarCall(cs8, 0x384B, unknown_17C6_0388_17FE8);
    CheckExternalEvents(cs8, 0x384E);
    // MOV AX,0x3b58 (1000_384B / 0x1384B)
    AX = 0x3B58;
    CheckExternalEvents(cs8, 0x384F);
    // PUSH DS (1000_384E / 0x1384E)
    Stack.Push16(DS);
    CheckExternalEvents(cs8, 0x3850);
    // PUSH AX (1000_384F / 0x1384F)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x3855);
    // CALLF 0x1000:8055 (1000_3850 / 0x13850)
    FarCall(cs8, 0x3855, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs8, 0x3858);
    // ADD SP,0x4 (1000_3855 / 0x13855)
    // SP += 0x4;
    SP = Alu16.Add(SP, 0x4);
    CheckExternalEvents(cs8, 0x385B);
    // MOV AX,0x3b8c (1000_3858 / 0x13858)
    AX = 0x3B8C;
    CheckExternalEvents(cs8, 0x385C);
    // PUSH DS (1000_385B / 0x1385B)
    Stack.Push16(DS);
    CheckExternalEvents(cs8, 0x385D);
    // PUSH AX (1000_385C / 0x1385C)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x3862);
    // CALLF 0x1000:8055 (1000_385D / 0x1385D)
    FarCall(cs8, 0x3862, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs8, 0x3865);
    // ADD SP,0x4 (1000_3862 / 0x13862)
    // SP += 0x4;
    SP = Alu16.Add(SP, 0x4);
    CheckExternalEvents(cs8, 0x386A);
    // MOV word ptr [BP + -0xa],0x0 (1000_3865 / 0x13865)
    UInt16[SS, (ushort)(BP - 0xA)] = 0x0;
    label_1000_386A_1386A:
    CheckExternalEvents(cs8, 0x386D);
    // MOV AX,0x30 (1000_386A / 0x1386A)
    AX = 0x30;
    CheckExternalEvents(cs8, 0x3870);
    ...
    CheckExternalEvents(cs8, 0x3A47);
    // MOV AX,0x3c89 (1000_3A44 / 0x13A44)
    AX = 0x3C89;
    CheckExternalEvents(cs8, 0x3A48);
    // PUSH DS (1000_3A47 / 0x13A47)
    Stack.Push16(DS);
    CheckExternalEvents(cs8, 0x3A49);
    // PUSH AX (1000_3A48 / 0x13A48)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x3A4E);
    // CALLF 0x1000:8055 (1000_3A49 / 0x13A49)
    FarCall(cs8, 0x3A4E, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs8, 0x3A51);
    // ADD SP,0x4 (1000_3A4E / 0x13A4E)
    // SP += 0x4;
    SP = Alu16.Add(SP, 0x4);
    CheckExternalEvents(cs8, 0x3A55);
    // MOV ES,word ptr [0x561a] (1000_3A51 / 0x13A51)
    ES = UInt16[DS, 0x561A];
    CheckExternalEvents(cs8, 0x3A5A);
    // PUSH word ptr ES:[0x3770] (1000_3A55 / 0x13A55)
    Stack.Push16(UInt16[ES, 0x3770]);
    CheckExternalEvents(cs8, 0x3A5F);
    // CALLF 0x1000:8b23 (1000_3A5A / 0x13A5A)
    FarCall(cs8, 0x3A5F, ghidra_guess_1000_8B23_18B23);
    CheckExternalEvents(cs8, 0x3A62);
    // ADD SP,0x2 (1000_3A5F / 0x13A5F)
    // SP += 0x2;
    SP = Alu16.Add(SP, 0x2);
    CheckExternalEvents(cs8, 0x3A65);
    // MOV AX,0x3c93 (1000_3A62 / 0x13A62)
    AX = 0x3C93;
    CheckExternalEvents(cs8, 0x3A66);
    // PUSH DS (1000_3A65 / 0x13A65)
    Stack.Push16(DS);
    CheckExternalEvents(cs8, 0x3A67);
    // PUSH AX (1000_3A66 / 0x13A66)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x3A6C);
    // CALLF 0x1000:8055 (1000_3A67 / 0x13A67)
    FarCall(cs8, 0x3A6C, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs8, 0x3A6F);
    // ADD SP,0x4 (1000_3A6C / 0x13A6C)
    // SP += 0x4;
    SP = Alu16.Add(SP, 0x4);
    CheckExternalEvents(cs8, 0x3A72);
    // MOV AX,0xe (1000_3A6F / 0x13A6F)
    AX = 0xE;
    CheckExternalEvents(cs8, 0x3A73);
    // PUSH AX (1000_3A72 / 0x13A72)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x3A76);
    // MOV AX,0x1 (1000_3A73 / 0x13A73)
    AX = 0x1;
    CheckExternalEvents(cs8, 0x3A77);
    // PUSH AX (1000_3A76 / 0x13A76)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x3A7B);
    // MOV ES,word ptr [0x5612] (1000_3A77 / 0x13A77)
    ES = UInt16[DS, 0x5612];
    CheckExternalEvents(cs8, 0x3A80);
    // PUSH word ptr ES:[0x377a] (1000_3A7B / 0x13A7B)
    Stack.Push16(UInt16[ES, 0x377A]);
    CheckExternalEvents(cs8, 0x3A84);
    // MOV ES,word ptr [0x5610] (1000_3A80 / 0x13A80)
    ES = UInt16[DS, 0x5610];
    CheckExternalEvents(cs8, 0x3A89);
    // PUSH word ptr ES:[0x3778] (1000_3A84 / 0x13A84)
    Stack.Push16(UInt16[ES, 0x3778]);
    CheckExternalEvents(cs8, 0x3A8E);
    // CALLF 0x1000:ca77 (1000_3A89 / 0x13A89)
    FarCall(cs8, 0x3A8E, unknown_19EF_2B87_1CA77);
    CheckExternalEvents(cs8, 0x3A91);
    // ADD SP,0x8 (1000_3A8E / 0x13A8E)
    // SP += 0x8;
    SP = Alu16.Add(SP, 0x8);
    label_1000_3A91_13A91:
    CheckExternalEvents(cs8, 0x3A96);
    // CALLF 0x1000:8d29 (1000_3A91 / 0x13A91)
    FarCall(cs8, 0x3A96, unknown_18AD_0259_18D29);
    CheckExternalEvents(cs8, 0x3A97);
    // PUSH AX (1000_3A96 / 0x13A96)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x3A9C);
    // CALLF 0x1000:897d (1000_3A97 / 0x13A97)
    FarCall(cs8, 0x3A9C, unknown_17C6_0D1D_1897D);
    CheckExternalEvents(cs8, 0x3A9F);
    // ADD SP,0x2 (1000_3A9C / 0x13A9C)
    // SP += 0x2;
    SP = Alu16.Add(SP, 0x2);
    CheckExternalEvents(cs8, 0x3AA2);
    // MOV word ptr [BP + -0x12],AX (1000_3A9F / 0x13A9F)
    UInt16[SS, (ushort)(BP - 0x12)] = AX;
    CheckExternalEvents(cs8, 0x3AA4);
    // SUB AX,AX (1000_3AA2 / 0x13AA2)
    // AX -= AX;
    AX = Alu16.Sub(AX, AX);
    CheckExternalEvents(cs8, 0x3AA7);
    // MOV word ptr [BP + -0x8],AX (1000_3AA4 / 0x13AA4)
    UInt16[SS, (ushort)(BP - 0x8)] = AX;
    CheckExternalEvents(cs8, 0x3AAA);
    // MOV word ptr [BP + -0x4],AX (1000_3AA7 / 0x13AA7)
    UInt16[SS, (ushort)(BP - 0x4)] = AX;
    CheckExternalEvents(cs8, 0x3AAD);
    // MOV AX,word ptr [BP + -0x12] (1000_3AAA / 0x13AAA)
    AX = UInt16[SS, (ushort)(BP - 0x12)];
    CheckExternalEvents(cs8, 0x3AB0);
    // SUB AX,0xffaf (1000_3AAD / 0x13AAD)
    AX -= 0xFFAF;
    CheckExternalEvents(cs8, 0x3AB3);
    // CMP AX,0xa (1000_3AB0 / 0x13AB0)
    Alu16.Sub(AX, 0xA);
    CheckExternalEvents(cs8, 0x3AB5);
    ...
    CheckExternalEvents(cs8, 0x3AB7);
    // ADD AX,AX (1000_3AB5 / 0x13AB5)
    // AX += AX;
    AX = Alu16.Add(AX, AX);
    CheckExternalEvents(cs8, 0x3AB8);
    // XCHG AX,BX (1000_3AB7 / 0x13AB7)
    (BX, AX) = (AX, BX);
    label_1000_3AB8_13AB8:
    CheckExternalEvents(cs8, 0x3ABD);
    ...
    uint targetAddress_1000_3AB8 = (uint)(cs8 * 0x10 + UInt16[cs8, (ushort)(BX + 0x2049)] - cs1 * 0x10);
  ...
  public virtual Action split_1000_3B0F_13B0F(int loadOffset) {
    ...
    CheckExternalEvents(cs8, 0x3CD6);
  ...
  public virtual Action ghidra_guess_1000_3CD6_13CD6(int loadOffset) {
    ...
    CheckExternalEvents(cs8, 0x3CDB);
    // CALLF 0x1000:7fe8 (1000_3CD6 / 0x13CD6)
    FarCall(cs8, 0x3CDB, unknown_17C6_0388_17FE8);
    CheckExternalEvents(cs8, 0x3CDC);
    // POP SI (1000_3CDB / 0x13CDB)
    SI = Stack.Pop16();;
    CheckExternalEvents(cs8, 0x3CDD);
    // POP DI (1000_3CDC / 0x13CDC)
    DI = Stack.Pop16();;
    CheckExternalEvents(cs8, 0x3CDF);
    // MOV SP,BP (1000_3CDD / 0x13CDD)
    SP = BP;
    CheckExternalEvents(cs8, 0x3CE0);
    // POP BP (1000_3CDF / 0x13CDF)
    BP = Stack.Pop16();;
    CheckExternalEvents(cs8, 0x3CE1);
  ...
  public virtual Action ghidra_guess_1000_3CE1_13CE1(int loadOffset) {
    ...
    CheckExternalEvents(cs8, 0x3CE2);
    // PUSH BP (1000_3CE1 / 0x13CE1)
    Stack.Push16(BP);
    CheckExternalEvents(cs8, 0x3CE4);
    // MOV BP,SP (1000_3CE2 / 0x13CE2)
    BP = SP;
    CheckExternalEvents(cs8, 0x3CE7);
    // MOV AX,0x4 (1000_3CE4 / 0x13CE4)
    AX = 0x4;
    CheckExternalEvents(cs8, 0x3CEC);
    // CALLF 0x1000:cecc (1000_3CE7 / 0x13CE7)
    FarCall(cs8, 0x3CEC, unknown_19EF_2FDC_1CECC);
    CheckExternalEvents(cs8, 0x3CED);
    // PUSH SI (1000_3CEC / 0x13CEC)
    Stack.Push16(SI);
    CheckExternalEvents(cs8, 0x3CF0);
    // MOV AX,0x4 (1000_3CED / 0x13CED)
    AX = 0x4;
    CheckExternalEvents(cs8, 0x3CF1);
    // PUSH AX (1000_3CF0 / 0x13CF0)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x3CF6);
    // CALLF 0x1000:7ee1 (1000_3CF1 / 0x13CF1)
    FarCall(cs8, 0x3CF6, unknown_17C6_0281_17EE1);
    CheckExternalEvents(cs8, 0x3CF9);
    // ADD SP,0x2 (1000_3CF6 / 0x13CF6)
    // SP += 0x2;
    SP = Alu16.Add(SP, 0x2);
    CheckExternalEvents(cs8, 0x3CFE);
    // CALLF 0x1000:7fe8 (1000_3CF9 / 0x13CF9)
    FarCall(cs8, 0x3CFE, unknown_17C6_0388_17FE8);
    CheckExternalEvents(cs8, 0x3D01);
    // MOV AX,0x7d (1000_3CFE / 0x13CFE)
    AX = 0x7D;
    CheckExternalEvents(cs8, 0x3D04);
  ...
  public virtual Action ghidra_guess_1000_3D6C_13D6C(int loadOffset) {
    ...
    CheckExternalEvents(cs8, 0x3D6D);
    // PUSH BP (1000_3D6C / 0x13D6C)
    Stack.Push16(BP);
    CheckExternalEvents(cs8, 0x3D6F);
    // MOV BP,SP (1000_3D6D / 0x13D6D)
    BP = SP;
    CheckExternalEvents(cs8, 0x3D72);
    // MOV AX,0x6 (1000_3D6F / 0x13D6F)
    AX = 0x6;
    CheckExternalEvents(cs8, 0x3D77);
    // CALLF 0x1000:cecc (1000_3D72 / 0x13D72)
    FarCall(cs8, 0x3D77, unknown_19EF_2FDC_1CECC);
    CheckExternalEvents(cs8, 0x3D78);
    // PUSH SI (1000_3D77 / 0x13D77)
    Stack.Push16(SI);
    CheckExternalEvents(cs8, 0x3D7C);
    // MOV ES,word ptr [0x5624] (1000_3D78 / 0x13D78)
    ES = UInt16[DS, 0x5624];
    CheckExternalEvents(cs8, 0x3D7E);
    // SUB AX,AX (1000_3D7C / 0x13D7C)
    // AX -= AX;
    AX = Alu16.Sub(AX, AX);
    CheckExternalEvents(cs8, 0x3D82);
    // MOV ES:[0x4592],AX (1000_3D7E / 0x13D7E)
    UInt16[ES, 0x4592] = AX;
    CheckExternalEvents(cs8, 0x3D86);
    // MOV ES,word ptr [0x5626] (1000_3D82 / 0x13D82)
    ES = UInt16[DS, 0x5626];
    CheckExternalEvents(cs8, 0x3D8A);
    // MOV ES:[0x377c],AX (1000_3D86 / 0x13D86)
    UInt16[ES, 0x377C] = AX;
    CheckExternalEvents(cs8, 0x3D8D);
    // MOV AX,0x7d (1000_3D8A / 0x13D8A)
    AX = 0x7D;
    CheckExternalEvents(cs8, 0x3D90);
