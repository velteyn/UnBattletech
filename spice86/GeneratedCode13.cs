...
public partial class GeneratedOverrides : CSharpOverrideHelper {
  ...
  public virtual Action ghidra_guess_1000_3F24_13F24(int loadOffset) {
    ...
    CheckExternalEvents(cs8, 0x3F46);
    // MOV AX,0x11 (1000_3F43 / 0x13F43)
    AX = 0x11;
    CheckExternalEvents(cs8, 0x3F49);
    ...
    CheckExternalEvents(cs8, 0x3F4B);
    // MOV BX,AX (1000_3F49 / 0x13F49)
    BX = AX;
    CheckExternalEvents(cs8, 0x3F4F);
    // MOV ES,word ptr [0x55d4] (1000_3F4B / 0x13F4B)
    ES = UInt16[DS, 0x55D4];
    CheckExternalEvents(cs8, 0x3F51);
    // MOV AL,0x3 (1000_3F4F / 0x13F4F)
    AL = 0x3;
    CheckExternalEvents(cs8, 0x3F56);
  ...
  public virtual Action ghidra_guess_1000_3FA0_13FA0(int loadOffset) {
    ...
    CheckExternalEvents(cs8, 0x3FA1);
    // PUSH BP (1000_3FA0 / 0x13FA0)
    Stack.Push16(BP);
    CheckExternalEvents(cs8, 0x3FA3);
    // MOV BP,SP (1000_3FA1 / 0x13FA1)
    BP = SP;
    CheckExternalEvents(cs8, 0x3FA6);
    // MOV AX,0x2 (1000_3FA3 / 0x13FA3)
    AX = 0x2;
    CheckExternalEvents(cs8, 0x3FAB);
    // CALLF 0x1000:cecc (1000_3FA6 / 0x13FA6)
    FarCall(cs8, 0x3FAB, unknown_19EF_2FDC_1CECC);
    CheckExternalEvents(cs8, 0x3FAE);
    // MOV AX,0x3 (1000_3FAB / 0x13FAB)
    AX = 0x3;
    CheckExternalEvents(cs8, 0x3FAF);
    // PUSH AX (1000_3FAE / 0x13FAE)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x3FB4);
    // CALLF 0x1000:7ee1 (1000_3FAF / 0x13FAF)
    FarCall(cs8, 0x3FB4, unknown_17C6_0281_17EE1);
    CheckExternalEvents(cs8, 0x3FB7);
    // ADD SP,0x2 (1000_3FB4 / 0x13FB4)
    // SP += 0x2;
    SP = Alu16.Add(SP, 0x2);
    CheckExternalEvents(cs8, 0x3FBC);
    // CALLF 0x1000:7fe8 (1000_3FB7 / 0x13FB7)
    FarCall(cs8, 0x3FBC, unknown_17C6_0388_17FE8);
    CheckExternalEvents(cs8, 0x3FBF);
    // MOV AX,0x3d3a (1000_3FBC / 0x13FBC)
    AX = 0x3D3A;
    CheckExternalEvents(cs8, 0x3FC0);
    // PUSH DS (1000_3FBF / 0x13FBF)
    Stack.Push16(DS);
    CheckExternalEvents(cs8, 0x3FC1);
    // PUSH AX (1000_3FC0 / 0x13FC0)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x3FC6);
    // CALLF 0x1000:8055 (1000_3FC1 / 0x13FC1)
    FarCall(cs8, 0x3FC6, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs8, 0x3FC9);
    // ADD SP,0x4 (1000_3FC6 / 0x13FC6)
    // SP += 0x4;
    SP = Alu16.Add(SP, 0x4);
    CheckExternalEvents(cs8, 0x3FCD);
    // MOV ES,word ptr [0x560c] (1000_3FC9 / 0x13FC9)
    ES = UInt16[DS, 0x560C];
    CheckExternalEvents(cs8, 0x3FD4);
    // MOV word ptr ES:[0xc2],0x2 (1000_3FCD / 0x13FCD)
    UInt16[ES, 0xC2] = 0x2;
    CheckExternalEvents(cs8, 0x3FDB);
    // MOV word ptr ES:[0xc6],0x3 (1000_3FD4 / 0x13FD4)
    UInt16[ES, 0xC6] = 0x3;
    CheckExternalEvents(cs8, 0x3FDF);
    // MOV ES,word ptr [0x55f4] (1000_3FDB / 0x13FDB)
    ES = UInt16[DS, 0x55F4];
    CheckExternalEvents(cs8, 0x3FE3);
    // MOV AX,ES:[0x2e38] (1000_3FDF / 0x13FDF)
    AX = UInt16[ES, 0x2E38];
    CheckExternalEvents(cs8, 0x3FE7);
    // MOV ES,word ptr [0x560c] (1000_3FE3 / 0x13FE3)
    ES = UInt16[DS, 0x560C];
    CheckExternalEvents(cs8, 0x3FEB);
    // MOV ES:[0xc8],AX (1000_3FE7 / 0x13FE7)
    UInt16[ES, 0xC8] = AX;
    CheckExternalEvents(cs8, 0x3FEE);
    // MOV AX,0x3 (1000_3FEB / 0x13FEB)
    AX = 0x3;
    CheckExternalEvents(cs8, 0x3FEF);
    // PUSH AX (1000_3FEE / 0x13FEE)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x3FF4);
    // CALLF 0x1000:87be (1000_3FEF / 0x13FEF)
    FarCall(cs8, 0x3FF4, unknown_17C6_0B5E_187BE);
    CheckExternalEvents(cs8, 0x3FF7);
    // MOV word ptr [BP + -0x2],AX (1000_3FF4 / 0x13FF4)
    UInt16[SS, (ushort)(BP - 0x2)] = AX;
    CheckExternalEvents(cs8, 0x3FFB);
    // MOV ES,word ptr [0x560c] (1000_3FF7 / 0x13FF7)
    ES = UInt16[DS, 0x560C];
    CheckExternalEvents(cs8, 0x4002);
    // MOV word ptr ES:[0xc2],0x0 (1000_3FFB / 0x13FFB)
    UInt16[ES, 0xC2] = 0x0;
    CheckExternalEvents(cs8, 0x4004);
    // MOV SP,BP (1000_4002 / 0x14002)
    SP = BP;
    CheckExternalEvents(cs8, 0x4005);
    // POP BP (1000_4004 / 0x14004)
    BP = Stack.Pop16();;
    CheckExternalEvents(cs8, 0x4006);
  ...
  public virtual Action ghidra_guess_1000_4006_14006(int loadOffset) {
    ...
    CheckExternalEvents(cs8, 0x4007);
    // PUSH BP (1000_4006 / 0x14006)
    Stack.Push16(BP);
    CheckExternalEvents(cs8, 0x4009);
    // MOV BP,SP (1000_4007 / 0x14007)
    BP = SP;
    CheckExternalEvents(cs8, 0x400C);
    // MOV AX,0x2 (1000_4009 / 0x14009)
    AX = 0x2;
    CheckExternalEvents(cs8, 0x4011);
    // CALLF 0x1000:cecc (1000_400C / 0x1400C)
    FarCall(cs8, 0x4011, unknown_19EF_2FDC_1CECC);
    CheckExternalEvents(cs8, 0x4014);
    // MOV AX,0x3 (1000_4011 / 0x14011)
    AX = 0x3;
    CheckExternalEvents(cs8, 0x4015);
    // PUSH AX (1000_4014 / 0x14014)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x401A);
    // CALLF 0x1000:7ee1 (1000_4015 / 0x14015)
    FarCall(cs8, 0x401A, unknown_17C6_0281_17EE1);
    CheckExternalEvents(cs8, 0x401D);
    // ADD SP,0x2 (1000_401A / 0x1401A)
    // SP += 0x2;
    SP = Alu16.Add(SP, 0x2);
    CheckExternalEvents(cs8, 0x4022);
    // CALLF 0x1000:7fe8 (1000_401D / 0x1401D)
    FarCall(cs8, 0x4022, unknown_17C6_0388_17FE8);
    CheckExternalEvents(cs8, 0x4025);
    // MOV AX,0x3d5e (1000_4022 / 0x14022)
    AX = 0x3D5E;
    CheckExternalEvents(cs8, 0x4026);
    // PUSH DS (1000_4025 / 0x14025)
    Stack.Push16(DS);
    CheckExternalEvents(cs8, 0x4027);
    // PUSH AX (1000_4026 / 0x14026)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x402C);
    // CALLF 0x1000:8055 (1000_4027 / 0x14027)
    FarCall(cs8, 0x402C, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs8, 0x402F);
    // ADD SP,0x4 (1000_402C / 0x1402C)
    // SP += 0x4;
    SP = Alu16.Add(SP, 0x4);
    CheckExternalEvents(cs8, 0x4033);
    // MOV ES,word ptr [0x55f6] (1000_402F / 0x1402F)
    ES = UInt16[DS, 0x55F6];
    CheckExternalEvents(cs8, 0x4038);
    // PUSH word ptr ES:[0x2e3a] (1000_4033 / 0x14033)
    Stack.Push16(UInt16[ES, 0x2E3A]);
    CheckExternalEvents(cs8, 0x403D);
    // CALLF 0x0000:3113 (1000_4038 / 0x14038)
    FarCall(cs8, 0x403D, unknown_0170_1A13_03113);
    CheckExternalEvents(cs8, 0x403F);
    // MOV SP,BP (1000_403D / 0x1403D)
    SP = BP;
    CheckExternalEvents(cs8, 0x4040);
    // POP BP (1000_403F / 0x1403F)
    BP = Stack.Pop16();;
    CheckExternalEvents(cs8, 0x4041);
  ...
  public virtual Action ghidra_guess_1000_4553_14553(int loadOffset) {
    ...
    CheckExternalEvents(cs8, 0x4554);
    // PUSH BP (1000_4553 / 0x14553)
    Stack.Push16(BP);
    CheckExternalEvents(cs8, 0x4556);
    // MOV BP,SP (1000_4554 / 0x14554)
    BP = SP;
    CheckExternalEvents(cs8, 0x4558);
    // XOR AX,AX (1000_4556 / 0x14556)
    // AX ^= AX;
    AX = Alu16.Xor(AX, AX);
    CheckExternalEvents(cs8, 0x455D);
    // CALLF 0x1000:cecc (1000_4558 / 0x14558)
    FarCall(cs8, 0x455D, unknown_19EF_2FDC_1CECC);
    CheckExternalEvents(cs8, 0x4560);
    // PUSH word ptr [BP + 0x8] (1000_455D / 0x1455D)
    Stack.Push16(UInt16[SS, (ushort)(BP + 0x8)]);
    CheckExternalEvents(cs8, 0x4563);
    // PUSH word ptr [BP + 0x6] (1000_4560 / 0x14560)
    Stack.Push16(UInt16[SS, (ushort)(BP + 0x6)]);
    CheckExternalEvents(cs8, 0x4568);
    // CALLF 0x0000:2ebb (1000_4563 / 0x14563)
    FarCall(cs8, 0x4568, ghidra_guess_0000_2EBB_02EBB);
    CheckExternalEvents(cs8, 0x456B);
    // ADD SP,0x4 (1000_4568 / 0x14568)
    // SP += 0x4;
    SP = Alu16.Add(SP, 0x4);
    CheckExternalEvents(cs8, 0x456F);
    // MOV ES,word ptr [0x55ce] (1000_456B / 0x1456B)
    ES = UInt16[DS, 0x55CE];
    CheckExternalEvents(cs8, 0x4574);
    // PUSH word ptr ES:[0xa44d] (1000_456F / 0x1456F)
    Stack.Push16(UInt16[ES, 0xA44D]);
    CheckExternalEvents(cs8, 0x4578);
    // MOV ES,word ptr [0x55cc] (1000_4574 / 0x14574)
    ES = UInt16[DS, 0x55CC];
    CheckExternalEvents(cs8, 0x457D);
    // PUSH word ptr ES:[0xa44b] (1000_4578 / 0x14578)
    Stack.Push16(UInt16[ES, 0xA44B]);
    CheckExternalEvents(cs8, 0x4582);
    // CALLF 0x1000:b204 (1000_457D / 0x1457D)
    FarCall(cs8, 0x4582, unknown_19EF_1314_1B204);
    CheckExternalEvents(cs8, 0x4585);
    // ADD SP,0x4 (1000_4582 / 0x14582)
    // SP += 0x4;
    SP = Alu16.Add(SP, 0x4);
    CheckExternalEvents(cs8, 0x458A);
    // CALLF 0x1000:bce8 (1000_4585 / 0x14585)
    FarCall(cs8, 0x458A, unknown_19EF_1DF8_1BCE8);
    CheckExternalEvents(cs8, 0x458B);
    // POP BP (1000_458A / 0x1458A)
    BP = Stack.Pop16();;
    CheckExternalEvents(cs8, 0x458C);
  ...
  public virtual Action ghidra_guess_1000_458C_1458C(int loadOffset) {
    ...
    CheckExternalEvents(cs8, 0x483F);
    // MOV AX,0x24 (1000_483C / 0x1483C)
    AX = 0x24;
    CheckExternalEvents(cs8, 0x4840);
    // PUSH AX (1000_483F / 0x1483F)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x4843);
    // PUSH word ptr [BP + -0x2] (1000_4840 / 0x14840)
    Stack.Push16(UInt16[SS, (ushort)(BP - 0x2)]);
    CheckExternalEvents(cs8, 0x4848);
    // CALLF 0x1000:1554 (1000_4843 / 0x14843)
    FarCall(cs8, 0x4848, ghidra_guess_1000_1554_11554);
    CheckExternalEvents(cs8, 0x484B);
    // ADD SP,0x4 (1000_4848 / 0x14848)
    SP += 0x4;
    CheckExternalEvents(cs8, 0x484E);
    // ADD word ptr [BP + -0x30],AX (1000_484B / 0x1484B)
    // UInt16[SS, (ushort)(BP - 0x30)] += AX;
    UInt16[SS, (ushort)(BP - 0x30)] = Alu16.Add(UInt16[SS, (ushort)(BP - 0x30)], AX);
    CheckExternalEvents(cs8, 0x4851);
    // MOV AX,0x25 (1000_484E / 0x1484E)
    AX = 0x25;
    CheckExternalEvents(cs8, 0x4852);
    // PUSH AX (1000_4851 / 0x14851)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x4855);
    // PUSH word ptr [BP + -0x2] (1000_4852 / 0x14852)
    Stack.Push16(UInt16[SS, (ushort)(BP - 0x2)]);
    CheckExternalEvents(cs8, 0x485A);
    // CALLF 0x1000:1554 (1000_4855 / 0x14855)
    FarCall(cs8, 0x485A, ghidra_guess_1000_1554_11554);
    CheckExternalEvents(cs8, 0x485D);
    // ADD SP,0x4 (1000_485A / 0x1485A)
    SP += 0x4;
    CheckExternalEvents(cs8, 0x4860);
    // ADD word ptr [BP + -0x30],AX (1000_485D / 0x1485D)
    // UInt16[SS, (ushort)(BP - 0x30)] += AX;
    UInt16[SS, (ushort)(BP - 0x30)] = Alu16.Add(UInt16[SS, (ushort)(BP - 0x30)], AX);
    label_1000_4860_14860:
    CheckExternalEvents(cs8, 0x4863);
    // MOV AX,0x30 (1000_4860 / 0x14860)
    AX = 0x30;
    CheckExternalEvents(cs8, 0x4866);
    ...
    CheckExternalEvents(cs8, 0x48DA);
    // MOV AX,0x11 (1000_48D7 / 0x148D7)
    AX = 0x11;
    CheckExternalEvents(cs8, 0x48DD);
    ...
    CheckExternalEvents(cs8, 0x4BC3);
    // MOV BX,AX (1000_4BC1 / 0x14BC1)
    BX = AX;
    CheckExternalEvents(cs8, 0x4BC7);
    // MOV ES,word ptr [0x5648] (1000_4BC3 / 0x14BC3)
    ES = UInt16[DS, 0x5648];
    CheckExternalEvents(cs8, 0x4BC9);
    // MOV AL,0x11 (1000_4BC7 / 0x14BC7)
    AL = 0x11;
    CheckExternalEvents(cs8, 0x4BCE);
    ...
    CheckExternalEvents(cs8, 0x4E16);
    // MOV BX,AX (1000_4E14 / 0x14E14)
    BX = AX;
    CheckExternalEvents(cs8, 0x4E1B);
    ...
    CheckExternalEvents(cs8, 0x4E1D);
    // JMP 0x1000:4e3c (1000_4E1B / 0x14E1B)
    goto label_1000_4E3C_14E3C;
    label_1000_4E1D_14E1D:
    CheckExternalEvents(cs8, 0x4E20);
    // MOV AX,0x11 (1000_4E1D / 0x14E1D)
    AX = 0x11;
    CheckExternalEvents(cs8, 0x4E23);
    ...
    CheckExternalEvents(cs8, 0x4E6C);
    // MOV BX,AX (1000_4E6A / 0x14E6A)
    BX = AX;
    CheckExternalEvents(cs8, 0x4E71);
    ...
    CheckExternalEvents(cs8, 0x513B);
    // MOV BX,AX (1000_5139 / 0x15139)
    BX = AX;
    CheckExternalEvents(cs8, 0x513E);
    // ADD BX,word ptr [BP + -0x60] (1000_513B / 0x1513B)
    // BX += UInt16[SS, (ushort)(BP - 0x60)];
    BX = Alu16.Add(BX, UInt16[SS, (ushort)(BP - 0x60)]);
    CheckExternalEvents(cs8, 0x5142);
    // MOV ES,word ptr [0x5648] (1000_513E / 0x1513E)
    ES = UInt16[DS, 0x5648];
    CheckExternalEvents(cs8, 0x5147);
    ...
    CheckExternalEvents(cs8, 0x5303);
    // MOV BX,AX (1000_5301 / 0x15301)
    BX = AX;
    CheckExternalEvents(cs8, 0x5306);
    // ADD BX,word ptr [BP + -0x42] (1000_5303 / 0x15303)
    // BX += UInt16[SS, (ushort)(BP - 0x42)];
    BX = Alu16.Add(BX, UInt16[SS, (ushort)(BP - 0x42)]);
    CheckExternalEvents(cs8, 0x530A);
    // MOV ES,word ptr [0x564e] (1000_5306 / 0x15306)
    ES = UInt16[DS, 0x564E];
    CheckExternalEvents(cs8, 0x5310);
