...
public partial class GeneratedOverrides : CSharpOverrideHelper {
  ...
  public virtual Action unknown_1643_0004_16434(int loadOffset) {
    ...
    CheckExternalEvents(cs8, 0x5);
    // PUSH BP (1643_0004 / 0x16434)
    Stack.Push16(BP);
    CheckExternalEvents(cs8, 0x7);
    // MOV BP,SP (1643_0005 / 0x16435)
    BP = SP;
    CheckExternalEvents(cs8, 0xA);
    // MOV AX,0x34 (1643_0007 / 0x16437)
    AX = 0x34;
    CheckExternalEvents(cs8, 0xF);
    // CALLF 0x1000:cecc (1643_000A / 0x1643A)
    FarCall(cs8, 0xF, unknown_19EF_2FDC_1CECC);
    CheckExternalEvents(cs8, 0x10);
    // PUSH DI (1643_000F / 0x1643F)
    Stack.Push16(DI);
    CheckExternalEvents(cs8, 0x11);
    // PUSH SI (1643_0010 / 0x16440)
    Stack.Push16(SI);
    CheckExternalEvents(cs8, 0x14);
    // MOV AX,word ptr [BP + 0x6] (1643_0011 / 0x16441)
    AX = UInt16[SS, (ushort)(BP + 0x6)];
    CheckExternalEvents(cs8, 0x17);
    // SUB AX,0x1 (1643_0014 / 0x16444)
    AX -= 0x1;
    CheckExternalEvents(cs8, 0x1A);
    // CMP AX,0x2e (1643_0017 / 0x16447)
    Alu.Sub16(AX, 0x2E);
    CheckExternalEvents(cs8, 0x1C);
    // JBE 0x1000:644f (1643_001A / 0x1644A)
    if(CarryFlag || ZeroFlag) {
      goto label_1643_001F_1644F;
    }
    CheckExternalEvents(cs8, 0x1F);
    ...
    CheckExternalEvents(cs8, 0x21);
    // ADD AX,AX (1643_001F / 0x1644F)
    // AX += AX;
    AX = Alu.Add16(AX, AX);
    CheckExternalEvents(cs8, 0x22);
    // XCHG AX,BX (1643_0021 / 0x16451)
    (BX, AX) = (AX, BX);
    CheckExternalEvents(cs8, 0x27);
    ...
    uint targetAddress_1643_0022 = (uint)(cs8 * 0x10 + UInt16[cs8, (ushort)(BX + 0x1762)] - cs1 * 0x10);
    switch(targetAddress_1643_0022) {
      ...
      case 0x16F22 : throw FailAsUntested("Would have been a goto but label label_1643_0AF2_16F22 does not exist because no instruction was found there that belongs to a function.");
  ...
  public virtual Action split_1000_65E5_165E5(int loadOffset) {
    ...
    CheckExternalEvents(cs7, 0x65E6);
    // PUSH DS (1000_65E5 / 0x165E5)
    Stack.Push16(DS);
    CheckExternalEvents(cs7, 0x65E7);
    // PUSH AX (1000_65E6 / 0x165E6)
    Stack.Push16(AX);
    CheckExternalEvents(cs7, 0x65EC);
    // CALLF 0x1000:8055 (1000_65E7 / 0x165E7)
    FarCall(cs7, 0x65EC, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs7, 0x65EF);
    // ADD SP,0x4 (1000_65EC / 0x165EC)
    // SP += 0x4;
    SP = Alu.Add16(SP, 0x4);
    CheckExternalEvents(cs7, 0x65F2);
  ...
  public virtual Action split_1000_6D87_16D87(int loadOffset) {
    ...
    CheckExternalEvents(cs7, 0x6D88);
    // PUSH DS (1000_6D87 / 0x16D87)
    Stack.Push16(DS);
    CheckExternalEvents(cs7, 0x6D89);
    // PUSH AX (1000_6D88 / 0x16D88)
    Stack.Push16(AX);
    CheckExternalEvents(cs7, 0x6D8E);
    // CALLF 0x1000:8055 (1000_6D89 / 0x16D89)
    FarCall(cs7, 0x6D8E, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs7, 0x6D91);
    // ADD SP,0x4 (1000_6D8E / 0x16D8E)
    // SP += 0x4;
    SP = Alu.Add16(SP, 0x4);
    CheckExternalEvents(cs7, 0x6D96);
    // CALLF 0x1000:19ef (1000_6D91 / 0x16D91)
    FarCall(cs7, 0x6D96, unknown_0FA1_1FDF_119EF);
    CheckExternalEvents(cs7, 0x6D99);
  ...
  public virtual Action split_1000_7400_17400(int loadOffset) {
    entrydispatcher:
    if(loadOffset != 0) {
      throw FailAsUntested("External goto not supported for this function.");
    }
    label_1000_7400_17400:
    CheckExternalEvents(cs7, 0x7403);
    // JMP 0x1000:7bf0 (1000_7400 / 0x17400)
    // Jump converted to entry function call
    if(JumpDispatcher.Jump(split_1000_7BF0_17BF0, 0)) {
      loadOffset = JumpDispatcher.NextEntryAddress;
      goto entrydispatcher;
  ...
  public virtual Action split_1000_7BF0_17BF0(int loadOffset) {
    ...
    CheckExternalEvents(cs7, 0x7BF1);
    // POP SI (1000_7BF0 / 0x17BF0)
    SI = Stack.Pop16();;
    CheckExternalEvents(cs7, 0x7BF2);
    // POP DI (1000_7BF1 / 0x17BF1)
    DI = Stack.Pop16();;
    CheckExternalEvents(cs7, 0x7BF4);
    // MOV SP,BP (1000_7BF2 / 0x17BF2)
    SP = BP;
    CheckExternalEvents(cs7, 0x7BF5);
    // POP BP (1000_7BF4 / 0x17BF4)
    BP = Stack.Pop16();;
    CheckExternalEvents(cs7, 0x7BF6);
  ...
  public virtual Action unknown_1643_17C6_17BF6(int loadOffset) {
    ...
    CheckExternalEvents(cs8, 0x17C8);
    // XOR AX,AX (1643_17C6 / 0x17BF6)
    // AX ^= AX;
    AX = Alu.Xor16(AX, AX);
    CheckExternalEvents(cs8, 0x17CD);
    // CALLF 0x1000:cecc (1643_17C8 / 0x17BF8)
    FarCall(cs8, 0x17CD, unknown_19EF_2FDC_1CECC);
    CheckExternalEvents(cs8, 0x17D0);
    // MOV AX,0x7 (1643_17CD / 0x17BFD)
    AX = 0x7;
    CheckExternalEvents(cs8, 0x17D1);
    // PUSH AX (1643_17D0 / 0x17C00)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x17D6);
    // CALLF 0x1000:7ee1 (1643_17D1 / 0x17C01)
    FarCall(cs8, 0x17D6, unknown_17C6_0281_17EE1);
    CheckExternalEvents(cs8, 0x17D9);
    // ADD SP,0x2 (1643_17D6 / 0x17C06)
    // SP += 0x2;
    SP = Alu.Add16(SP, 0x2);
    CheckExternalEvents(cs8, 0x17DE);
    // CALLF 0x1000:7fe8 (1643_17D9 / 0x17C09)
    FarCall(cs8, 0x17DE, unknown_17C6_0388_17FE8);
    CheckExternalEvents(cs8, 0x17E0);
    // SUB AX,AX (1643_17DE / 0x17C0E)
    // AX -= AX;
    AX = Alu.Sub16(AX, AX);
    CheckExternalEvents(cs8, 0x17E1);
    // PUSH AX (1643_17E0 / 0x17C10)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0x17E6);
    // CALLF 0x1000:7c64 (1643_17E1 / 0x17C11)
    FarCall(cs8, 0x17E6, unknown_17C6_0004_17C64);
    CheckExternalEvents(cs8, 0x17E9);
    // ADD SP,0x2 (1643_17E6 / 0x17C16)
    // SP += 0x2;
    SP = Alu.Add16(SP, 0x2);
    CheckExternalEvents(cs8, 0x17EA);
    // RETF  (1643_17E9 / 0x17C19)
    return FarRet();
  }
  
  public virtual Action ghidra_guess_1000_7C1A_17C1A(int loadOffset) {
    entrydispatcher:
    if(loadOffset != 0) {
      throw FailAsUntested("External goto not supported for this function.");
    }
    label_1000_7C1A_17C1A:
    CheckExternalEvents(cs7, 0x7C1B);
    // PUSH BP (1000_7C1A / 0x17C1A)
    Stack.Push16(BP);
    CheckExternalEvents(cs7, 0x7C1D);
    // MOV BP,SP (1000_7C1B / 0x17C1B)
    BP = SP;
    CheckExternalEvents(cs7, 0x7C1F);
    // XOR AX,AX (1000_7C1D / 0x17C1D)
    // AX ^= AX;
    AX = Alu.Xor16(AX, AX);
    CheckExternalEvents(cs7, 0x7C24);
    // CALLF 0x1000:cecc (1000_7C1F / 0x17C1F)
    FarCall(cs7, 0x7C24, unknown_19EF_2FDC_1CECC);
    CheckExternalEvents(cs7, 0x7C27);
    // PUSH word ptr [BP + 0x8] (1000_7C24 / 0x17C24)
    Stack.Push16(UInt16[SS, (ushort)(BP + 0x8)]);
    CheckExternalEvents(cs7, 0x7C2A);
    // PUSH word ptr [BP + 0x6] (1000_7C27 / 0x17C27)
    Stack.Push16(UInt16[SS, (ushort)(BP + 0x6)]);
    CheckExternalEvents(cs7, 0x7C2F);
    // CALLF 0x1000:8055 (1000_7C2A / 0x17C2A)
    FarCall(cs7, 0x7C2F, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs7, 0x7C32);
    // ADD SP,0x4 (1000_7C2F / 0x17C2F)
    // SP += 0x4;
    SP = Alu.Add16(SP, 0x4);
    CheckExternalEvents(cs7, 0x7C37);
    // CALLF 0x1000:933a (1000_7C32 / 0x17C32)
    FarCall(cs7, 0x7C37, ghidra_guess_1000_933A_1933A);
    CheckExternalEvents(cs7, 0x7C38);
    // POP BP (1000_7C37 / 0x17C37)
    BP = Stack.Pop16();;
    CheckExternalEvents(cs7, 0x7C39);
    // RETF  (1000_7C38 / 0x17C38)
    return FarRet();
  }
  
  public virtual Action ghidra_guess_1000_7C39_17C39(int loadOffset) {
    entrydispatcher:
    if(loadOffset != 0) {
      throw FailAsUntested("External goto not supported for this function.");
    }
    label_1000_7C39_17C39:
    CheckExternalEvents(cs7, 0x7C3B);
    // XOR AX,AX (1000_7C39 / 0x17C39)
    // AX ^= AX;
    AX = Alu.Xor16(AX, AX);
    CheckExternalEvents(cs7, 0x7C40);
    // CALLF 0x1000:cecc (1000_7C3B / 0x17C3B)
    FarCall(cs7, 0x7C40, unknown_19EF_2FDC_1CECC);
    CheckExternalEvents(cs7, 0x7C43);
    // MOV AX,0x4f7e (1000_7C40 / 0x17C40)
    AX = 0x4F7E;
    CheckExternalEvents(cs7, 0x7C44);
    // PUSH DS (1000_7C43 / 0x17C43)
    Stack.Push16(DS);
    CheckExternalEvents(cs7, 0x7C45);
    // PUSH AX (1000_7C44 / 0x17C44)
    Stack.Push16(AX);
    CheckExternalEvents(cs7, 0x7C4A);
    // CALLF 0x1000:8055 (1000_7C45 / 0x17C45)
    FarCall(cs7, 0x7C4A, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs7, 0x7C4D);
    // ADD SP,0x4 (1000_7C4A / 0x17C4A)
    // SP += 0x4;
    SP = Alu.Add16(SP, 0x4);
    CheckExternalEvents(cs7, 0x7C4E);
    // RETF  (1000_7C4D / 0x17C4D)
    return FarRet();
  }
  
  public virtual Action ghidra_guess_1000_7C4E_17C4E(int loadOffset) {
    entrydispatcher:
    if(loadOffset != 0) {
      throw FailAsUntested("External goto not supported for this function.");
    }
    label_1000_7C4E_17C4E:
    CheckExternalEvents(cs7, 0x7C50);
    // XOR AX,AX (1000_7C4E / 0x17C4E)
    // AX ^= AX;
    AX = Alu.Xor16(AX, AX);
    CheckExternalEvents(cs7, 0x7C55);
    // CALLF 0x1000:cecc (1000_7C50 / 0x17C50)
    FarCall(cs7, 0x7C55, unknown_19EF_2FDC_1CECC);
    CheckExternalEvents(cs7, 0x7C58);
    // MOV AX,0x4fa0 (1000_7C55 / 0x17C55)
    AX = 0x4FA0;
    CheckExternalEvents(cs7, 0x7C59);
    // PUSH DS (1000_7C58 / 0x17C58)
    Stack.Push16(DS);
    CheckExternalEvents(cs7, 0x7C5A);
    // PUSH AX (1000_7C59 / 0x17C59)
    Stack.Push16(AX);
    CheckExternalEvents(cs7, 0x7C5F);
    // CALLF 0x1000:8055 (1000_7C5A / 0x17C5A)
    FarCall(cs7, 0x7C5F, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs7, 0x7C62);
    // ADD SP,0x4 (1000_7C5F / 0x17C5F)
    // SP += 0x4;
    SP = Alu.Add16(SP, 0x4);
    CheckExternalEvents(cs7, 0x7C63);
    // RETF  (1000_7C62 / 0x17C62)
    return FarRet();
  }
  
  public virtual Action unknown_17C6_0004_17C64(int loadOffset) {
    entrydispatcher:
    if(loadOffset != 0) {
      throw FailAsUntested("External goto not supported for this function.");
    }
    label_17C6_0004_17C64:
    CheckExternalEvents(cs9, 0x5);
    // PUSH BP (17C6_0004 / 0x17C64)
    Stack.Push16(BP);
    CheckExternalEvents(cs9, 0x7);
    // MOV BP,SP (17C6_0005 / 0x17C65)
    BP = SP;
    CheckExternalEvents(cs9, 0xA);
    // MOV AX,0x14 (17C6_0007 / 0x17C67)
    AX = 0x14;
    CheckExternalEvents(cs9, 0xF);
    // CALLF 0x1000:cecc (17C6_000A / 0x17C6A)
    FarCall(cs9, 0xF, unknown_19EF_2FDC_1CECC);
    CheckExternalEvents(cs9, 0x13);
    // MOV ES,word ptr [0x56d0] (17C6_000F / 0x17C6F)
    ES = UInt16[DS, 0x56D0];
    CheckExternalEvents(cs9, 0x17);
    // MOV AX,ES:[0x39a0] (17C6_0013 / 0x17C73)
    AX = UInt16[ES, 0x39A0];
    CheckExternalEvents(cs9, 0x1A);
    // MOV word ptr [BP + -0xc],AX (17C6_0017 / 0x17C77)
    UInt16[SS, (ushort)(BP - 0xC)] = AX;
    CheckExternalEvents(cs9, 0x1E);
    // MOV ES,word ptr [0x56d2] (17C6_001A / 0x17C7A)
    ES = UInt16[DS, 0x56D2];
    CheckExternalEvents(cs9, 0x22);
    // MOV AX,ES:[0x39a4] (17C6_001E / 0x17C7E)
    AX = UInt16[ES, 0x39A4];
    CheckExternalEvents(cs9, 0x25);
    // MOV word ptr [BP + -0xe],AX (17C6_0022 / 0x17C82)
    UInt16[SS, (ushort)(BP - 0xE)] = AX;
    CheckExternalEvents(cs9, 0x28);
    // MOV BX,word ptr [BP + 0x6] (17C6_0025 / 0x17C85)
    BX = UInt16[SS, (ushort)(BP + 0x6)];
    CheckExternalEvents(cs9, 0x2A);
    // SHL BX,0x1 (17C6_0028 / 0x17C88)
    BX <<= 0x1;
    CheckExternalEvents(cs9, 0x2C);
    // SHL BX,0x1 (17C6_002A / 0x17C8A)
    // BX <<= 0x1;
    BX = Alu.Shl16(BX, 0x1);
    CheckExternalEvents(cs9, 0x30);
    // MOV AX,word ptr [BX + 0x4fa4] (17C6_002C / 0x17C8C)
    AX = UInt16[DS, (ushort)(BX + 0x4FA4)];
    CheckExternalEvents(cs9, 0x34);
    // MOV DX,word ptr [BX + 0x4fa6] (17C6_0030 / 0x17C90)
    DX = UInt16[DS, (ushort)(BX + 0x4FA6)];
    CheckExternalEvents(cs9, 0x37);
    // MOV word ptr [BP + -0x4],AX (17C6_0034 / 0x17C94)
    UInt16[SS, (ushort)(BP - 0x4)] = AX;
    CheckExternalEvents(cs9, 0x3A);
    // MOV word ptr [BP + -0x2],DX (17C6_0037 / 0x17C97)
    UInt16[SS, (ushort)(BP - 0x2)] = DX;
    CheckExternalEvents(cs9, 0x3D);
    // LES BX,[BP + -0x4] (17C6_003A / 0x17C9A)
    BX = UInt16[SS, (ushort)(BP - 0x4)];
    ES = UInt16[SS, (ushort)(BP - 0x4 + 2)];
    CheckExternalEvents(cs9, 0x40);
    // MOV AX,word ptr ES:[BX] (17C6_003D / 0x17C9D)
    AX = UInt16[ES, (ushort)(BX)];
    CheckExternalEvents(cs9, 0x42);
    // MOV CL,0x5 (17C6_0040 / 0x17CA0)
    CL = 0x5;
    CheckExternalEvents(cs9, 0x44);
    // SHL AX,CL (17C6_0042 / 0x17CA2)
    // AX <<= CL;
    AX = Alu.Shl16(AX, CL);
    CheckExternalEvents(cs9, 0x48);
    // MOV ES,word ptr [0x56d4] (17C6_0044 / 0x17CA4)
    ES = UInt16[DS, 0x56D4];
    CheckExternalEvents(cs9, 0x4D);
    // ADD AX,word ptr ES:[0x4066] (17C6_0048 / 0x17CA8)
    // AX += UInt16[ES, 0x4066];
    AX = Alu.Add16(AX, UInt16[ES, 0x4066]);
    CheckExternalEvents(cs9, 0x52);
    // MOV DX,word ptr ES:[0x4068] (17C6_004D / 0x17CAD)
    DX = UInt16[ES, 0x4068];
    CheckExternalEvents(cs9, 0x55);
    // MOV word ptr [BP + -0x14],AX (17C6_0052 / 0x17CB2)
    UInt16[SS, (ushort)(BP - 0x14)] = AX;
    CheckExternalEvents(cs9, 0x58);
    // MOV word ptr [BP + -0x12],DX (17C6_0055 / 0x17CB5)
    UInt16[SS, (ushort)(BP - 0x12)] = DX;
    CheckExternalEvents(cs9, 0x5B);
    // MOV AX,word ptr [BP + -0xe] (17C6_0058 / 0x17CB8)
    AX = UInt16[SS, (ushort)(BP - 0xE)];
    CheckExternalEvents(cs9, 0x5C);
    // DEC AX (17C6_005B / 0x17CBB)
    AX = Alu.Dec16(AX);
    CheckExternalEvents(cs9, 0x5D);
    // PUSH AX (17C6_005C / 0x17CBC)
    Stack.Push16(AX);
    CheckExternalEvents(cs9, 0x60);
    // MOV AX,word ptr [BP + -0xc] (17C6_005D / 0x17CBD)
    AX = UInt16[SS, (ushort)(BP - 0xC)];
    CheckExternalEvents(cs9, 0x61);
    // DEC AX (17C6_0060 / 0x17CC0)
    AX = Alu.Dec16(AX);
    CheckExternalEvents(cs9, 0x62);
    // PUSH AX (17C6_0061 / 0x17CC1)
    Stack.Push16(AX);
    CheckExternalEvents(cs9, 0x63);
    // PUSH DX (17C6_0062 / 0x17CC2)
    Stack.Push16(DX);
    CheckExternalEvents(cs9, 0x66);
    // PUSH word ptr [BP + -0x14] (17C6_0063 / 0x17CC3)
    Stack.Push16(UInt16[SS, (ushort)(BP - 0x14)]);
    CheckExternalEvents(cs9, 0x6B);
    // CALLF 0x1000:c64c (17C6_0066 / 0x17CC6)
    FarCall(cs9, 0x6B, unknown_19EF_275C_1C64C);
    CheckExternalEvents(cs9, 0x6E);
    // ADD SP,0x8 (17C6_006B / 0x17CCB)
    // SP += 0x8;
    SP = Alu.Add16(SP, 0x8);
    CheckExternalEvents(cs9, 0x71);
    // LES BX,[BP + -0x4] (17C6_006E / 0x17CCE)
    BX = UInt16[SS, (ushort)(BP - 0x4)];
    ES = UInt16[SS, (ushort)(BP - 0x4 + 2)];
    CheckExternalEvents(cs9, 0x75);
    // MOV AX,word ptr ES:[BX + 0x2] (17C6_0071 / 0x17CD1)
    AX = UInt16[ES, (ushort)(BX + 0x2)];
    CheckExternalEvents(cs9, 0x77);
    // MOV CL,0x5 (17C6_0075 / 0x17CD5)
    CL = 0x5;
    CheckExternalEvents(cs9, 0x79);
    // SHL AX,CL (17C6_0077 / 0x17CD7)
    // AX <<= CL;
    AX = Alu.Shl16(AX, CL);
    CheckExternalEvents(cs9, 0x7D);
    // MOV ES,word ptr [0x56d4] (17C6_0079 / 0x17CD9)
    ES = UInt16[DS, 0x56D4];
    CheckExternalEvents(cs9, 0x82);
    // ADD AX,word ptr ES:[0x4066] (17C6_007D / 0x17CDD)
    // AX += UInt16[ES, 0x4066];
    AX = Alu.Add16(AX, UInt16[ES, 0x4066]);
    CheckExternalEvents(cs9, 0x87);
    // MOV DX,word ptr ES:[0x4068] (17C6_0082 / 0x17CE2)
    DX = UInt16[ES, 0x4068];
    CheckExternalEvents(cs9, 0x8A);
    // MOV word ptr [BP + -0x14],AX (17C6_0087 / 0x17CE7)
    UInt16[SS, (ushort)(BP - 0x14)] = AX;
    CheckExternalEvents(cs9, 0x8D);
    // MOV word ptr [BP + -0x12],DX (17C6_008A / 0x17CEA)
    UInt16[SS, (ushort)(BP - 0x12)] = DX;
    CheckExternalEvents(cs9, 0x90);
    // MOV AX,word ptr [BP + -0xe] (17C6_008D / 0x17CED)
    AX = UInt16[SS, (ushort)(BP - 0xE)];
    CheckExternalEvents(cs9, 0x91);
    // DEC AX (17C6_0090 / 0x17CF0)
    AX = Alu.Dec16(AX);
    CheckExternalEvents(cs9, 0x92);
    // PUSH AX (17C6_0091 / 0x17CF1)
    Stack.Push16(AX);
    CheckExternalEvents(cs9, 0x96);
    // MOV ES,word ptr [0x56d6] (17C6_0092 / 0x17CF2)
    ES = UInt16[DS, 0x56D6];
    CheckExternalEvents(cs9, 0x9A);
    // MOV AX,ES:[0x3990] (17C6_0096 / 0x17CF6)
    AX = UInt16[ES, 0x3990];
    CheckExternalEvents(cs9, 0x9D);
    // ADD AX,word ptr [BP + -0xc] (17C6_009A / 0x17CFA)
    // AX += UInt16[SS, (ushort)(BP - 0xC)];
    AX = Alu.Add16(AX, UInt16[SS, (ushort)(BP - 0xC)]);
    CheckExternalEvents(cs9, 0x9E);
    // PUSH AX (17C6_009D / 0x17CFD)
    Stack.Push16(AX);
    CheckExternalEvents(cs9, 0x9F);
    // PUSH DX (17C6_009E / 0x17CFE)
    Stack.Push16(DX);
    CheckExternalEvents(cs9, 0xA2);
    // PUSH word ptr [BP + -0x14] (17C6_009F / 0x17CFF)
    Stack.Push16(UInt16[SS, (ushort)(BP - 0x14)]);
    CheckExternalEvents(cs9, 0xA7);
    // CALLF 0x1000:c64c (17C6_00A2 / 0x17D02)
    FarCall(cs9, 0xA7, unknown_19EF_275C_1C64C);
    CheckExternalEvents(cs9, 0xAA);
    // ADD SP,0x8 (17C6_00A7 / 0x17D07)
    // SP += 0x8;
    SP = Alu.Add16(SP, 0x8);
    CheckExternalEvents(cs9, 0xAD);
    // LES BX,[BP + -0x4] (17C6_00AA / 0x17D0A)
    BX = UInt16[SS, (ushort)(BP - 0x4)];
    ES = UInt16[SS, (ushort)(BP - 0x4 + 2)];
    CheckExternalEvents(cs9, 0xB1);
    // MOV AX,word ptr ES:[BX + 0x4] (17C6_00AD / 0x17D0D)
    AX = UInt16[ES, (ushort)(BX + 0x4)];
    CheckExternalEvents(cs9, 0xB3);
    // MOV CL,0x5 (17C6_00B1 / 0x17D11)
    CL = 0x5;
    CheckExternalEvents(cs9, 0xB5);
    // SHL AX,CL (17C6_00B3 / 0x17D13)
    // AX <<= CL;
    AX = Alu.Shl16(AX, CL);
    CheckExternalEvents(cs9, 0xB9);
    // MOV ES,word ptr [0x56d4] (17C6_00B5 / 0x17D15)
    ES = UInt16[DS, 0x56D4];
    CheckExternalEvents(cs9, 0xBE);
    // ADD AX,word ptr ES:[0x4066] (17C6_00B9 / 0x17D19)
    // AX += UInt16[ES, 0x4066];
    AX = Alu.Add16(AX, UInt16[ES, 0x4066]);
    CheckExternalEvents(cs9, 0xC3);
    // MOV DX,word ptr ES:[0x4068] (17C6_00BE / 0x17D1E)
    DX = UInt16[ES, 0x4068];
    CheckExternalEvents(cs9, 0xC6);
    // MOV word ptr [BP + -0x14],AX (17C6_00C3 / 0x17D23)
    UInt16[SS, (ushort)(BP - 0x14)] = AX;
    CheckExternalEvents(cs9, 0xC9);
    // MOV word ptr [BP + -0x12],DX (17C6_00C6 / 0x17D26)
    UInt16[SS, (ushort)(BP - 0x12)] = DX;
    CheckExternalEvents(cs9, 0xCD);
    // MOV ES,word ptr [0x56d8] (17C6_00C9 / 0x17D29)
    ES = UInt16[DS, 0x56D8];
    CheckExternalEvents(cs9, 0xD1);
    // MOV AX,ES:[0x393a] (17C6_00CD / 0x17D2D)
    AX = UInt16[ES, 0x393A];
    CheckExternalEvents(cs9, 0xD4);
    // ADD AX,word ptr [BP + -0xe] (17C6_00D1 / 0x17D31)
    // AX += UInt16[SS, (ushort)(BP - 0xE)];
    AX = Alu.Add16(AX, UInt16[SS, (ushort)(BP - 0xE)]);
    CheckExternalEvents(cs9, 0xD5);
    // PUSH AX (17C6_00D4 / 0x17D34)
    Stack.Push16(AX);
    CheckExternalEvents(cs9, 0xD8);
    // MOV AX,word ptr [BP + -0xc] (17C6_00D5 / 0x17D35)
    AX = UInt16[SS, (ushort)(BP - 0xC)];
    CheckExternalEvents(cs9, 0xD9);
    // DEC AX (17C6_00D8 / 0x17D38)
    AX = Alu.Dec16(AX);
    CheckExternalEvents(cs9, 0xDA);
    // PUSH AX (17C6_00D9 / 0x17D39)
    Stack.Push16(AX);
    CheckExternalEvents(cs9, 0xDB);
    // PUSH DX (17C6_00DA / 0x17D3A)
    Stack.Push16(DX);
    CheckExternalEvents(cs9, 0xDE);
    // PUSH word ptr [BP + -0x14] (17C6_00DB / 0x17D3B)
    Stack.Push16(UInt16[SS, (ushort)(BP - 0x14)]);
    CheckExternalEvents(cs9, 0xE3);
    // CALLF 0x1000:c64c (17C6_00DE / 0x17D3E)
    FarCall(cs9, 0xE3, unknown_19EF_275C_1C64C);
    CheckExternalEvents(cs9, 0xE6);
    // ADD SP,0x8 (17C6_00E3 / 0x17D43)
    // SP += 0x8;
    SP = Alu.Add16(SP, 0x8);
    CheckExternalEvents(cs9, 0xE9);
    // LES BX,[BP + -0x4] (17C6_00E6 / 0x17D46)
    BX = UInt16[SS, (ushort)(BP - 0x4)];
    ES = UInt16[SS, (ushort)(BP - 0x4 + 2)];
    CheckExternalEvents(cs9, 0xED);
    // MOV AX,word ptr ES:[BX + 0x6] (17C6_00E9 / 0x17D49)
    AX = UInt16[ES, (ushort)(BX + 0x6)];
    CheckExternalEvents(cs9, 0xEF);
    // MOV CL,0x5 (17C6_00ED / 0x17D4D)
    CL = 0x5;
    CheckExternalEvents(cs9, 0xF1);
    // SHL AX,CL (17C6_00EF / 0x17D4F)
    // AX <<= CL;
    AX = Alu.Shl16(AX, CL);
    CheckExternalEvents(cs9, 0xF5);
    // MOV ES,word ptr [0x56d4] (17C6_00F1 / 0x17D51)
    ES = UInt16[DS, 0x56D4];
    CheckExternalEvents(cs9, 0xFA);
    // ADD AX,word ptr ES:[0x4066] (17C6_00F5 / 0x17D55)
    // AX += UInt16[ES, 0x4066];
    AX = Alu.Add16(AX, UInt16[ES, 0x4066]);
    CheckExternalEvents(cs9, 0xFF);
    // MOV DX,word ptr ES:[0x4068] (17C6_00FA / 0x17D5A)
    DX = UInt16[ES, 0x4068];
    CheckExternalEvents(cs9, 0x102);
    // MOV word ptr [BP + -0x14],AX (17C6_00FF / 0x17D5F)
    UInt16[SS, (ushort)(BP - 0x14)] = AX;
    CheckExternalEvents(cs9, 0x105);
    // MOV word ptr [BP + -0x12],DX (17C6_0102 / 0x17D62)
    UInt16[SS, (ushort)(BP - 0x12)] = DX;
    CheckExternalEvents(cs9, 0x109);
    // MOV ES,word ptr [0x56d8] (17C6_0105 / 0x17D65)
    ES = UInt16[DS, 0x56D8];
    CheckExternalEvents(cs9, 0x10D);
    // MOV AX,ES:[0x393a] (17C6_0109 / 0x17D69)
    AX = UInt16[ES, 0x393A];
    CheckExternalEvents(cs9, 0x110);
    // ADD AX,word ptr [BP + -0xe] (17C6_010D / 0x17D6D)
    // AX += UInt16[SS, (ushort)(BP - 0xE)];
    AX = Alu.Add16(AX, UInt16[SS, (ushort)(BP - 0xE)]);
    CheckExternalEvents(cs9, 0x111);
    // PUSH AX (17C6_0110 / 0x17D70)
    Stack.Push16(AX);
    CheckExternalEvents(cs9, 0x115);
    // MOV ES,word ptr [0x56d6] (17C6_0111 / 0x17D71)
    ES = UInt16[DS, 0x56D6];
    CheckExternalEvents(cs9, 0x119);
    // MOV AX,ES:[0x3990] (17C6_0115 / 0x17D75)
    AX = UInt16[ES, 0x3990];
    CheckExternalEvents(cs9, 0x11C);
    // ADD AX,word ptr [BP + -0xc] (17C6_0119 / 0x17D79)
    // AX += UInt16[SS, (ushort)(BP - 0xC)];
    AX = Alu.Add16(AX, UInt16[SS, (ushort)(BP - 0xC)]);
    CheckExternalEvents(cs9, 0x11D);
    // PUSH AX (17C6_011C / 0x17D7C)
    Stack.Push16(AX);
    CheckExternalEvents(cs9, 0x11E);
    // PUSH DX (17C6_011D / 0x17D7D)
    Stack.Push16(DX);
    CheckExternalEvents(cs9, 0x121);
    // PUSH word ptr [BP + -0x14] (17C6_011E / 0x17D7E)
    Stack.Push16(UInt16[SS, (ushort)(BP - 0x14)]);
    CheckExternalEvents(cs9, 0x126);
    // CALLF 0x1000:c64c (17C6_0121 / 0x17D81)
    FarCall(cs9, 0x126, unknown_19EF_275C_1C64C);
    CheckExternalEvents(cs9, 0x129);
    // ADD SP,0x8 (17C6_0126 / 0x17D86)
    // SP += 0x8;
    SP = Alu.Add16(SP, 0x8);
    CheckExternalEvents(cs9, 0x12E);
    // MOV word ptr [BP + -0x6],0x4 (17C6_0129 / 0x17D89)
    UInt16[SS, (ushort)(BP - 0x6)] = 0x4;
    CheckExternalEvents(cs9, 0x131);
    // MOV AX,0x1 (17C6_012E / 0x17D8E)
    AX = 0x1;
    CheckExternalEvents(cs9, 0x132);
    // PUSH AX (17C6_0131 / 0x17D91)
    Stack.Push16(AX);
    CheckExternalEvents(cs9, 0x136);
    // MOV ES,word ptr [0x56d6] (17C6_0132 / 0x17D92)
    ES = UInt16[DS, 0x56D6];
    CheckExternalEvents(cs9, 0x13B);
    // PUSH word ptr ES:[0x3990] (17C6_0136 / 0x17D96)
    Stack.Push16(UInt16[ES, 0x3990]);
    CheckExternalEvents(cs9, 0x13E);
    // MOV AX,word ptr [BP + -0xe] (17C6_013B / 0x17D9B)
    AX = UInt16[SS, (ushort)(BP - 0xE)];
    CheckExternalEvents(cs9, 0x13F);
    // DEC AX (17C6_013E / 0x17D9E)
    AX = Alu.Dec16(AX);
    CheckExternalEvents(cs9, 0x140);
    // PUSH AX (17C6_013F / 0x17D9F)
    Stack.Push16(AX);
    CheckExternalEvents(cs9, 0x143);
    // PUSH word ptr [BP + -0xc] (17C6_0140 / 0x17DA0)
    Stack.Push16(UInt16[SS, (ushort)(BP - 0xC)]);
    CheckExternalEvents(cs9, 0x146);
    // MOV AX,0x4 (17C6_0143 / 0x17DA3)
    AX = 0x4;
    CheckExternalEvents(cs9, 0x147);
    // PUSH AX (17C6_0146 / 0x17DA6)
    Stack.Push16(AX);
    CheckExternalEvents(cs9, 0x14A);
    // PUSH word ptr [BP + -0x2] (17C6_0147 / 0x17DA7)
    Stack.Push16(UInt16[SS, (ushort)(BP - 0x2)]);
    CheckExternalEvents(cs9, 0x14D);
    // PUSH word ptr [BP + -0x4] (17C6_014A / 0x17DAA)
    Stack.Push16(UInt16[SS, (ushort)(BP - 0x4)]);
    CheckExternalEvents(cs9, 0x14E);
    // PUSH CS (17C6_014D / 0x17DAD)
    Stack.Push16(cs9);
    CheckExternalEvents(cs9, 0x151);
    // CALL 0x1000:7e47 (17C6_014E / 0x17DAE)
    NearCall(cs9, 0x151, unknown_17C6_01E7_17E47);
    CheckExternalEvents(cs9, 0x154);
    // ADD SP,0xe (17C6_0151 / 0x17DB1)
    // SP += 0xE;
    SP = Alu.Add16(SP, 0xE);
    CheckExternalEvents(cs9, 0x157);
    // MOV word ptr [BP + -0x6],AX (17C6_0154 / 0x17DB4)
    UInt16[SS, (ushort)(BP - 0x6)] = AX;
    CheckExternalEvents(cs9, 0x159);
    // SUB AX,AX (17C6_0157 / 0x17DB7)
    // AX -= AX;
    AX = Alu.Sub16(AX, AX);
    CheckExternalEvents(cs9, 0x15A);
    // PUSH AX (17C6_0159 / 0x17DB9)
    Stack.Push16(AX);
    CheckExternalEvents(cs9, 0x15E);
    // MOV ES,word ptr [0x56d8] (17C6_015A / 0x17DBA)
    ES = UInt16[DS, 0x56D8];
    CheckExternalEvents(cs9, 0x163);
    // PUSH word ptr ES:[0x393a] (17C6_015E / 0x17DBE)
    Stack.Push16(UInt16[ES, 0x393A]);
    CheckExternalEvents(cs9, 0x166);
    // PUSH word ptr [BP + -0xe] (17C6_0163 / 0x17DC3)
    Stack.Push16(UInt16[SS, (ushort)(BP - 0xE)]);
    CheckExternalEvents(cs9, 0x16A);
    // MOV ES,word ptr [0x56d0] (17C6_0166 / 0x17DC6)
    ES = UInt16[DS, 0x56D0];
    CheckExternalEvents(cs9, 0x16E);
    // MOV AX,ES:[0x39a0] (17C6_016A / 0x17DCA)
    AX = UInt16[ES, 0x39A0];
    CheckExternalEvents(cs9, 0x16F);
    // DEC AX (17C6_016E / 0x17DCE)
    AX = Alu.Dec16(AX);
    CheckExternalEvents(cs9, 0x170);
    // PUSH AX (17C6_016F / 0x17DCF)
    Stack.Push16(AX);
    CheckExternalEvents(cs9, 0x173);
    // PUSH word ptr [BP + -0x6] (17C6_0170 / 0x17DD0)
    Stack.Push16(UInt16[SS, (ushort)(BP - 0x6)]);
    CheckExternalEvents(cs9, 0x176);
    // PUSH word ptr [BP + -0x2] (17C6_0173 / 0x17DD3)
    Stack.Push16(UInt16[SS, (ushort)(BP - 0x2)]);
    CheckExternalEvents(cs9, 0x179);
    // PUSH word ptr [BP + -0x4] (17C6_0176 / 0x17DD6)
    Stack.Push16(UInt16[SS, (ushort)(BP - 0x4)]);
    CheckExternalEvents(cs9, 0x17A);
    // PUSH CS (17C6_0179 / 0x17DD9)
    Stack.Push16(cs9);
    CheckExternalEvents(cs9, 0x17D);
    // CALL 0x1000:7e47 (17C6_017A / 0x17DDA)
    NearCall(cs9, 0x17D, unknown_17C6_01E7_17E47);
    CheckExternalEvents(cs9, 0x180);
    // ADD SP,0xe (17C6_017D / 0x17DDD)
    // SP += 0xE;
    SP = Alu.Add16(SP, 0xE);
    CheckExternalEvents(cs9, 0x183);
    // MOV word ptr [BP + -0x6],AX (17C6_0180 / 0x17DE0)
    UInt16[SS, (ushort)(BP - 0x6)] = AX;
    CheckExternalEvents(cs9, 0x185);
    // SUB AX,AX (17C6_0183 / 0x17DE3)
    // AX -= AX;
    AX = Alu.Sub16(AX, AX);
    CheckExternalEvents(cs9, 0x186);
    // PUSH AX (17C6_0185 / 0x17DE5)
    Stack.Push16(AX);
    CheckExternalEvents(cs9, 0x18A);
    // MOV ES,word ptr [0x56d8] (17C6_0186 / 0x17DE6)
    ES = UInt16[DS, 0x56D8];
    CheckExternalEvents(cs9, 0x18F);
    // PUSH word ptr ES:[0x393a] (17C6_018A / 0x17DEA)
    Stack.Push16(UInt16[ES, 0x393A]);
    CheckExternalEvents(cs9, 0x192);
    // PUSH word ptr [BP + -0xe] (17C6_018F / 0x17DEF)
    Stack.Push16(UInt16[SS, (ushort)(BP - 0xE)]);
    CheckExternalEvents(cs9, 0x196);
    // MOV ES,word ptr [0x56d0] (17C6_0192 / 0x17DF2)
    ES = UInt16[DS, 0x56D0];
    CheckExternalEvents(cs9, 0x19A);
    // MOV AX,ES:[0x39a0] (17C6_0196 / 0x17DF6)
    AX = UInt16[ES, 0x39A0];
    CheckExternalEvents(cs9, 0x19E);
    // MOV ES,word ptr [0x56d6] (17C6_019A / 0x17DFA)
    ES = UInt16[DS, 0x56D6];
    CheckExternalEvents(cs9, 0x1A3);
    // ADD AX,word ptr ES:[0x3990] (17C6_019E / 0x17DFE)
    // AX += UInt16[ES, 0x3990];
    AX = Alu.Add16(AX, UInt16[ES, 0x3990]);
    CheckExternalEvents(cs9, 0x1A4);
    // PUSH AX (17C6_01A3 / 0x17E03)
    Stack.Push16(AX);
    CheckExternalEvents(cs9, 0x1A7);
    // PUSH word ptr [BP + -0x6] (17C6_01A4 / 0x17E04)
    Stack.Push16(UInt16[SS, (ushort)(BP - 0x6)]);
    CheckExternalEvents(cs9, 0x1AA);
    // PUSH word ptr [BP + -0x2] (17C6_01A7 / 0x17E07)
    Stack.Push16(UInt16[SS, (ushort)(BP - 0x2)]);
    CheckExternalEvents(cs9, 0x1AD);
    // PUSH word ptr [BP + -0x4] (17C6_01AA / 0x17E0A)
    Stack.Push16(UInt16[SS, (ushort)(BP - 0x4)]);
    CheckExternalEvents(cs9, 0x1AE);
    // PUSH CS (17C6_01AD / 0x17E0D)
    Stack.Push16(cs9);
    CheckExternalEvents(cs9, 0x1B1);
    // CALL 0x1000:7e47 (17C6_01AE / 0x17E0E)
    NearCall(cs9, 0x1B1, unknown_17C6_01E7_17E47);
    CheckExternalEvents(cs9, 0x1B4);
    // ADD SP,0xe (17C6_01B1 / 0x17E11)
    // SP += 0xE;
    SP = Alu.Add16(SP, 0xE);
    CheckExternalEvents(cs9, 0x1B7);
    // MOV word ptr [BP + -0x6],AX (17C6_01B4 / 0x17E14)
    UInt16[SS, (ushort)(BP - 0x6)] = AX;
    CheckExternalEvents(cs9, 0x1BA);
    // MOV AX,0x1 (17C6_01B7 / 0x17E17)
    AX = 0x1;
    CheckExternalEvents(cs9, 0x1BB);
    // PUSH AX (17C6_01BA / 0x17E1A)
    Stack.Push16(AX);
    CheckExternalEvents(cs9, 0x1BF);
    // MOV ES,word ptr [0x56d6] (17C6_01BB / 0x17E1B)
    ES = UInt16[DS, 0x56D6];
    CheckExternalEvents(cs9, 0x1C4);
    // PUSH word ptr ES:[0x3990] (17C6_01BF / 0x17E1F)
    Stack.Push16(UInt16[ES, 0x3990]);
    CheckExternalEvents(cs9, 0x1C8);
    // MOV ES,word ptr [0x56d8] (17C6_01C4 / 0x17E24)
    ES = UInt16[DS, 0x56D8];
    CheckExternalEvents(cs9, 0x1CC);
    // MOV AX,ES:[0x393a] (17C6_01C8 / 0x17E28)
    AX = UInt16[ES, 0x393A];
    CheckExternalEvents(cs9, 0x1CF);
    // ADD AX,word ptr [BP + -0xe] (17C6_01CC / 0x17E2C)
    // AX += UInt16[SS, (ushort)(BP - 0xE)];
    AX = Alu.Add16(AX, UInt16[SS, (ushort)(BP - 0xE)]);
    CheckExternalEvents(cs9, 0x1D0);
    // PUSH AX (17C6_01CF / 0x17E2F)
    Stack.Push16(AX);
    CheckExternalEvents(cs9, 0x1D3);
    // PUSH word ptr [BP + -0xc] (17C6_01D0 / 0x17E30)
    Stack.Push16(UInt16[SS, (ushort)(BP - 0xC)]);
    CheckExternalEvents(cs9, 0x1D6);
    // PUSH word ptr [BP + -0x6] (17C6_01D3 / 0x17E33)
    Stack.Push16(UInt16[SS, (ushort)(BP - 0x6)]);
    CheckExternalEvents(cs9, 0x1D9);
    // PUSH word ptr [BP + -0x2] (17C6_01D6 / 0x17E36)
    Stack.Push16(UInt16[SS, (ushort)(BP - 0x2)]);
    CheckExternalEvents(cs9, 0x1DC);
    // PUSH word ptr [BP + -0x4] (17C6_01D9 / 0x17E39)
    Stack.Push16(UInt16[SS, (ushort)(BP - 0x4)]);
    CheckExternalEvents(cs9, 0x1DD);
    // PUSH CS (17C6_01DC / 0x17E3C)
    Stack.Push16(cs9);
    CheckExternalEvents(cs9, 0x1E0);
    // CALL 0x1000:7e47 (17C6_01DD / 0x17E3D)
    NearCall(cs9, 0x1E0, unknown_17C6_01E7_17E47);
    CheckExternalEvents(cs9, 0x1E3);
    // MOV word ptr [BP + -0x6],AX (17C6_01E0 / 0x17E40)
    UInt16[SS, (ushort)(BP - 0x6)] = AX;
    CheckExternalEvents(cs9, 0x1E5);
    // MOV SP,BP (17C6_01E3 / 0x17E43)
    SP = BP;
    CheckExternalEvents(cs9, 0x1E6);
    // POP BP (17C6_01E5 / 0x17E45)
    BP = Stack.Pop16();;
    CheckExternalEvents(cs9, 0x1E7);
    // RETF  (17C6_01E6 / 0x17E46)
    return FarRet();
  }
