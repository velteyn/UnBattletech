...
public partial class GeneratedOverrides : CSharpOverrideHelper {
  ...
  public virtual Action ghidra_guess_0000_AAA6_0AAA6(int loadOffset) {
    ...
    int resImul0000_AAD7 = Alu16.Imul((short)AX, (short)UInt16[SS, (ushort)(BP - 0x16)]);
    ...
    Alu16.Sub(UInt16[SS, (ushort)(BP - 0x14)], 0x1);
    ...
    int resImul0000_AB20 = Alu16.Imul((short)AX, (short)UInt16[SS, (ushort)(BP + 0x6)]);
    ...
    int resImul0000_AB52 = Alu16.Imul((short)AX, (short)UInt16[SS, (ushort)(BP + SI - 0x10)]);
    ...
    int resImul0000_AB97 = Alu16.Imul((short)AX, (short)UInt16[SS, (ushort)(BP + SI - 0x10)]);
    ...
    short resImul0000_ABA2 = Alu8.Imul((sbyte)AL, (sbyte)UInt8[ES, (ushort)(BX + 0xC61F)]);
    ...
    UInt16[SS, (ushort)(BP - 0x16)] = Alu16.Inc(UInt16[SS, (ushort)(BP - 0x16)]);
    ...
    FarCall(cs1, 0xAC60, unknown_18AD_086A_1933A);
  ...
  public virtual Action unknown_094C_17B9_0AC79(int loadOffset) {
    entrydispatcher:
    if(loadOffset != 0) {
      throw FailAsUntested("External goto not supported for this function.");
    }
    label_094C_17B9_0AC79:
    CheckExternalEvents(cs5, 0x17BA);
    // PUSH BP (094C_17B9 / 0xAC79)
    Stack.Push16(BP);
    CheckExternalEvents(cs5, 0x17BC);
    // MOV BP,SP (094C_17BA / 0xAC7A)
    BP = SP;
    CheckExternalEvents(cs5, 0x17BF);
    // MOV AX,0x12 (094C_17BC / 0xAC7C)
    AX = 0x12;
    CheckExternalEvents(cs5, 0x17C4);
    // CALLF 0x1000:cecc (094C_17BF / 0xAC7F)
    FarCall(cs5, 0x17C4, unknown_19EF_2FDC_1CECC);
    CheckExternalEvents(cs5, 0x17C5);
    // PUSH DI (094C_17C4 / 0xAC84)
    Stack.Push16(DI);
    CheckExternalEvents(cs5, 0x17C6);
    // PUSH SI (094C_17C5 / 0xAC85)
    Stack.Push16(SI);
    CheckExternalEvents(cs5, 0x17CB);
    // MOV word ptr [BP + -0xa],0x0 (094C_17C6 / 0xAC86)
    UInt16[SS, (ushort)(BP - 0xA)] = 0x0;
    CheckExternalEvents(cs5, 0x17CD);
    // JMP 0x0000:ac90 (094C_17CB / 0xAC8B)
    goto label_094C_17D0_0AC90;
    label_094C_17CD_0AC8D:
    CheckExternalEvents(cs5, 0x17D0);
    // INC word ptr [BP + -0xa] (094C_17CD / 0xAC8D)
    UInt16[SS, (ushort)(BP - 0xA)]++;
    label_094C_17D0_0AC90:
    CheckExternalEvents(cs5, 0x17D4);
    // CMP word ptr [BP + -0xa],0x8 (094C_17D0 / 0xAC90)
    Alu16.Sub(UInt16[SS, (ushort)(BP - 0xA)], 0x8);
    CheckExternalEvents(cs5, 0x17D6);
    // JGE 0x0000:acac (094C_17D4 / 0xAC94)
    if(SignFlag == OverflowFlag) {
      goto label_094C_17EC_0ACAC;
    }
    CheckExternalEvents(cs5, 0x17DA);
    // MOV ES,word ptr [0x545c] (094C_17D6 / 0xAC96)
    ES = UInt16[DS, 0x545C];
    CheckExternalEvents(cs5, 0x17DE);
    // MOV AL,ES:[0xd319] (094C_17DA / 0xAC9A)
    AL = UInt8[ES, 0xD319];
    CheckExternalEvents(cs5, 0x17E1);
    // MOV BX,word ptr [BP + -0xa] (094C_17DE / 0xAC9E)
    BX = UInt16[SS, (ushort)(BP - 0xA)];
    CheckExternalEvents(cs5, 0x17E5);
    // MOV ES,word ptr [0x5460] (094C_17E1 / 0xACA1)
    ES = UInt16[DS, 0x5460];
    CheckExternalEvents(cs5, 0x17EA);
    // CMP byte ptr ES:[BX + 0x4602],AL (094C_17E5 / 0xACA5)
    Alu8.Sub(UInt8[ES, (ushort)(BX + 0x4602)], AL);
    CheckExternalEvents(cs5, 0x17EC);
    // JNZ 0x0000:ac8d (094C_17EA / 0xACAA)
    if(!ZeroFlag) {
      goto label_094C_17CD_0AC8D;
    }
    label_094C_17EC_0ACAC:
    CheckExternalEvents(cs5, 0x17F1);
    // CALLF 0x1000:7fe8 (094C_17EC / 0xACAC)
    FarCall(cs5, 0x17F1, unknown_17C6_0388_17FE8);
    CheckExternalEvents(cs5, 0x17F6);
    // MOV word ptr [BP + -0xc],0x0 (094C_17F1 / 0xACB1)
    UInt16[SS, (ushort)(BP - 0xC)] = 0x0;
    CheckExternalEvents(cs5, 0x17FB);
    // MOV word ptr [BP + -0x12],0x0 (094C_17F6 / 0xACB6)
    UInt16[SS, (ushort)(BP - 0x12)] = 0x0;
    label_094C_17FB_0ACBB:
    CheckExternalEvents(cs5, 0x17FE);
    // MOV DI,word ptr [BP + -0x12] (094C_17FB / 0xACBB)
    DI = UInt16[SS, (ushort)(BP - 0x12)];
    CheckExternalEvents(cs5, 0x1802);
    // MOV byte ptr [BP + DI + -0x8],0x0 (094C_17FE / 0xACBE)
    UInt8[SS, (ushort)(BP + DI - 0x8)] = 0x0;
    CheckExternalEvents(cs5, 0x1805);
    // MOV AX,0x1a (094C_1802 / 0xACC2)
    AX = 0x1A;
    CheckExternalEvents(cs5, 0x1808);
    // IMUL word ptr [BP + -0x12] (094C_1805 / 0xACC5)
    int resImul094C_1805 = Alu16.Imul((short)AX, (short)UInt16[SS, (ushort)(BP - 0x12)]);
    AX = (ushort)(resImul094C_1805);
    DX = (ushort)(resImul094C_1805 >> 16);
    CheckExternalEvents(cs5, 0x180A);
    // MOV SI,AX (094C_1808 / 0xACC8)
    SI = AX;
    CheckExternalEvents(cs5, 0x180E);
    // MOV ES,word ptr [0x545c] (094C_180A / 0xACCA)
    ES = UInt16[DS, 0x545C];
    CheckExternalEvents(cs5, 0x1814);
    // CMP byte ptr ES:[SI + 0xd399],0x0 (094C_180E / 0xACCE)
    Alu8.Sub(UInt8[ES, (ushort)(SI + 0xD399)], 0x0);
    CheckExternalEvents(cs5, 0x1816);
    // JZ 0x0000:acfc (094C_1814 / 0xACD4)
    if(ZeroFlag) {
      goto label_094C_183C_0ACFC;
    }
    CheckExternalEvents(cs5, 0x181B);
    // MOV AL,byte ptr ES:[SI + 0xd398] (094C_1816 / 0xACD6)
    AL = UInt8[ES, (ushort)(SI + 0xD398)];
    CheckExternalEvents(cs5, 0x181D);
    // SUB AH,AH (094C_181B / 0xACDB)
    // AH -= AH;
    AH = Alu8.Sub(AH, AH);
    CheckExternalEvents(cs5, 0x1820);
    // MOV word ptr [BP + -0xe],AX (094C_181D / 0xACDD)
    UInt16[SS, (ushort)(BP - 0xE)] = AX;
    CheckExternalEvents(cs5, 0x1822);
    // MOV CL,0x4 (094C_1820 / 0xACE0)
    CL = 0x4;
    CheckExternalEvents(cs5, 0x1824);
    // SAR AX,CL (094C_1822 / 0xACE2)
    AX = Alu16.Sar(AX, CL);
    CheckExternalEvents(cs5, 0x1827);
    // AND AX,0x7 (094C_1824 / 0xACE4)
    // AX &= 0x7;
    AX = Alu16.And(AX, 0x7);
    CheckExternalEvents(cs5, 0x182A);
    // MOV word ptr [BP + -0xe],AX (094C_1827 / 0xACE7)
    UInt16[SS, (ushort)(BP - 0xE)] = AX;
    CheckExternalEvents(cs5, 0x182D);
    // MOV AX,word ptr [BP + -0xa] (094C_182A / 0xACEA)
    AX = UInt16[SS, (ushort)(BP - 0xA)];
    CheckExternalEvents(cs5, 0x1830);
    // CMP word ptr [BP + -0xe],AX (094C_182D / 0xACED)
    Alu16.Sub(UInt16[SS, (ushort)(BP - 0xE)], AX);
    CheckExternalEvents(cs5, 0x1832);
    // JNZ 0x0000:acfc (094C_1830 / 0xACF0)
    if(!ZeroFlag) {
      goto label_094C_183C_0ACFC;
    }
    CheckExternalEvents(cs5, 0x1835);
    // MOV DI,word ptr [BP + -0x12] (094C_1832 / 0xACF2)
    DI = UInt16[SS, (ushort)(BP - 0x12)];
    CheckExternalEvents(cs5, 0x1839);
    // MOV byte ptr [BP + DI + -0x8],0x1 (094C_1835 / 0xACF5)
    UInt8[SS, (ushort)(BP + DI - 0x8)] = 0x1;
    CheckExternalEvents(cs5, 0x183C);
    // INC word ptr [BP + -0xc] (094C_1839 / 0xACF9)
    UInt16[SS, (ushort)(BP - 0xC)]++;
    label_094C_183C_0ACFC:
    CheckExternalEvents(cs5, 0x183F);
    // INC word ptr [BP + -0x12] (094C_183C / 0xACFC)
    UInt16[SS, (ushort)(BP - 0x12)]++;
    CheckExternalEvents(cs5, 0x1843);
    // CMP word ptr [BP + -0x12],0x8 (094C_183F / 0xACFF)
    Alu16.Sub(UInt16[SS, (ushort)(BP - 0x12)], 0x8);
    CheckExternalEvents(cs5, 0x1845);
    // JL 0x0000:acbb (094C_1843 / 0xAD03)
    if(SignFlag != OverflowFlag) {
      goto label_094C_17FB_0ACBB;
    }
    CheckExternalEvents(cs5, 0x1849);
    // CMP word ptr [BP + -0xc],0x0 (094C_1845 / 0xAD05)
    Alu16.Sub(UInt16[SS, (ushort)(BP - 0xC)], 0x0);
    CheckExternalEvents(cs5, 0x184B);
    // JNZ 0x0000:ad13 (094C_1849 / 0xAD09)
    if(!ZeroFlag) {
      goto label_094C_1853_0AD13;
    }
    CheckExternalEvents(cs5, 0x184E);
    // MOV AX,0x16de (094C_184B / 0xAD0B)
    AX = 0x16DE;
    CheckExternalEvents(cs5, 0x184F);
    // PUSH DS (094C_184E / 0xAD0E)
    Stack.Push16(DS);
    CheckExternalEvents(cs5, 0x1850);
    // PUSH AX (094C_184F / 0xAD0F)
    Stack.Push16(AX);
    CheckExternalEvents(cs5, 0x1853);
    // JMP 0x0000:ae8e (094C_1850 / 0xAD10)
    goto label_094C_19CE_0AE8E;
    label_094C_1853_0AD13:
    CheckExternalEvents(cs5, 0x1856);
    // MOV AX,0x170e (094C_1853 / 0xAD13)
    AX = 0x170E;
    CheckExternalEvents(cs5, 0x1857);
    // PUSH DS (094C_1856 / 0xAD16)
    Stack.Push16(DS);
    CheckExternalEvents(cs5, 0x1858);
    // PUSH AX (094C_1857 / 0xAD17)
    Stack.Push16(AX);
    CheckExternalEvents(cs5, 0x185D);
    // CALLF 0x1000:8055 (094C_1858 / 0xAD18)
    FarCall(cs5, 0x185D, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs5, 0x1860);
    // ADD SP,0x4 (094C_185D / 0xAD1D)
    // SP += 0x4;
    SP = Alu16.Add(SP, 0x4);
    CheckExternalEvents(cs5, 0x1865);
    // MOV word ptr [BP + -0x12],0x0 (094C_1860 / 0xAD20)
    UInt16[SS, (ushort)(BP - 0x12)] = 0x0;
    label_094C_1865_0AD25:
    CheckExternalEvents(cs5, 0x1868);
    // MOV SI,word ptr [BP + -0x12] (094C_1865 / 0xAD25)
    SI = UInt16[SS, (ushort)(BP - 0x12)];
    CheckExternalEvents(cs5, 0x186C);
    // CMP byte ptr [BP + SI + -0x8],0x0 (094C_1868 / 0xAD28)
    Alu8.Sub(UInt8[SS, (ushort)(BP + SI - 0x8)], 0x0);
    CheckExternalEvents(cs5, 0x186E);
    // JZ 0x0000:ad4a (094C_186C / 0xAD2C)
    if(ZeroFlag) {
      goto label_094C_188A_0AD4A;
    }
    CheckExternalEvents(cs5, 0x1870);
    // MOV BX,SI (094C_186E / 0xAD2E)
    BX = SI;
    CheckExternalEvents(cs5, 0x1872);
    // MOV CL,0x4 (094C_1870 / 0xAD30)
    CL = 0x4;
    CheckExternalEvents(cs5, 0x1874);
    // SHL BX,CL (094C_1872 / 0xAD32)
    // BX <<= CL;
    BX = Alu16.Shl(BX, CL);
    CheckExternalEvents(cs5, 0x1878);
    // LEA AX,[BX + 0xa461] (094C_1874 / 0xAD34)
    AX = (ushort)(BX + 0xA461);
    CheckExternalEvents(cs5, 0x187B);
    // MOV DX,0x1ddc (094C_1878 / 0xAD38)
    DX = 0x1DDC;
    CheckExternalEvents(cs5, 0x187C);
    // PUSH DX (094C_187B / 0xAD3B)
    Stack.Push16(DX);
    CheckExternalEvents(cs5, 0x187D);
    // PUSH AX (094C_187C / 0xAD3C)
    Stack.Push16(AX);
    CheckExternalEvents(cs5, 0x1882);
    // CALLF 0x1000:8055 (094C_187D / 0xAD3D)
    FarCall(cs5, 0x1882, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs5, 0x1885);
    // ADD SP,0x4 (094C_1882 / 0xAD42)
    // SP += 0x4;
    SP = Alu16.Add(SP, 0x4);
    CheckExternalEvents(cs5, 0x188A);
    // CALLF 0x1000:7c4e (094C_1885 / 0xAD45)
    FarCall(cs5, 0x188A, ghidra_guess_1000_7C4E_17C4E);
    label_094C_188A_0AD4A:
    CheckExternalEvents(cs5, 0x188D);
    // INC word ptr [BP + -0x12] (094C_188A / 0xAD4A)
    UInt16[SS, (ushort)(BP - 0x12)]++;
    CheckExternalEvents(cs5, 0x1891);
    // CMP word ptr [BP + -0x12],0x8 (094C_188D / 0xAD4D)
    Alu16.Sub(UInt16[SS, (ushort)(BP - 0x12)], 0x8);
    CheckExternalEvents(cs5, 0x1893);
    // JL 0x0000:ad25 (094C_1891 / 0xAD51)
    if(SignFlag != OverflowFlag) {
      goto label_094C_1865_0AD25;
    }
    CheckExternalEvents(cs5, 0x1896);
    // MOV AX,0x1728 (094C_1893 / 0xAD53)
    AX = 0x1728;
    CheckExternalEvents(cs5, 0x1897);
    // PUSH DS (094C_1896 / 0xAD56)
    Stack.Push16(DS);
    CheckExternalEvents(cs5, 0x1898);
    // PUSH AX (094C_1897 / 0xAD57)
    Stack.Push16(AX);
    CheckExternalEvents(cs5, 0x189D);
    // CALLF 0x1000:8055 (094C_1898 / 0xAD58)
    FarCall(cs5, 0x189D, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs5, 0x18A0);
    // ADD SP,0x4 (094C_189D / 0xAD5D)
    // SP += 0x4;
    SP = Alu16.Add(SP, 0x4);
    CheckExternalEvents(cs5, 0x18A4);
    // MOV ES,word ptr [0x54a0] (094C_18A0 / 0xAD60)
    ES = UInt16[DS, 0x54A0];
    CheckExternalEvents(cs5, 0x18A7);
    // MOV AX,word ptr [BP + -0xc] (094C_18A4 / 0xAD64)
    AX = UInt16[SS, (ushort)(BP - 0xC)];
    CheckExternalEvents(cs5, 0x18A8);
    // INC AX (094C_18A7 / 0xAD67)
    AX = Alu16.Inc(AX);
    CheckExternalEvents(cs5, 0x18AC);
    // MOV ES:[0x1d6],AX (094C_18A8 / 0xAD68)
    UInt16[ES, 0x1D6] = AX;
    CheckExternalEvents(cs5, 0x18AF);
    // MOV AX,0x14 (094C_18AC / 0xAD6C)
    AX = 0x14;
    CheckExternalEvents(cs5, 0x18B0);
    // PUSH AX (094C_18AF / 0xAD6F)
    Stack.Push16(AX);
    CheckExternalEvents(cs5, 0x18B5);
    // CALLF 0x1000:87be (094C_18B0 / 0xAD70)
    FarCall(cs5, 0x18B5, unknown_17C6_0B5E_187BE);
    CheckExternalEvents(cs5, 0x18B8);
    // ADD SP,0x2 (094C_18B5 / 0xAD75)
    // SP += 0x2;
    SP = Alu16.Add(SP, 0x2);
    CheckExternalEvents(cs5, 0x18BB);
    // MOV word ptr [BP + -0x10],AX (094C_18B8 / 0xAD78)
    UInt16[SS, (ushort)(BP - 0x10)] = AX;
    CheckExternalEvents(cs5, 0x18BE);
    // MOV AX,word ptr [BP + -0xc] (094C_18BB / 0xAD7B)
    AX = UInt16[SS, (ushort)(BP - 0xC)];
    CheckExternalEvents(cs5, 0x18C1);
    // CMP word ptr [BP + -0x10],AX (094C_18BE / 0xAD7E)
    Alu16.Sub(UInt16[SS, (ushort)(BP - 0x10)], AX);
    CheckExternalEvents(cs5, 0x18C3);
    // JNZ 0x0000:ad86 (094C_18C1 / 0xAD81)
    if(!ZeroFlag) {
      goto label_094C_18C6_0AD86;
    }
    CheckExternalEvents(cs5, 0x18C6);
    // JMP 0x0000:ae9b (094C_18C3 / 0xAD83)
    goto label_094C_19DB_0AE9B;
    label_094C_18C6_0AD86:
    CheckExternalEvents(cs5, 0x18CA);
    // MOV ES,word ptr [0x545c] (094C_18C6 / 0xAD86)
    ES = UInt16[DS, 0x545C];
    CheckExternalEvents(cs5, 0x18D0);
    // CMP byte ptr ES:[0xd339],0x0 (094C_18CA / 0xAD8A)
    Alu8.Sub(UInt8[ES, 0xD339], 0x0);
    CheckExternalEvents(cs5, 0x18D2);
    // JZ 0x0000:adb3 (094C_18D0 / 0xAD90)
    if(ZeroFlag) {
      goto label_094C_18F3_0ADB3;
    }
    CheckExternalEvents(cs5, 0x18D6);
    // CMP word ptr [BP + -0xe],0x7 (094C_18D2 / 0xAD92)
    Alu16.Sub(UInt16[SS, (ushort)(BP - 0xE)], 0x7);
    CheckExternalEvents(cs5, 0x18D8);
    // JNZ 0x0000:adb3 (094C_18D6 / 0xAD96)
    if(!ZeroFlag) {
      goto label_094C_18F3_0ADB3;
    }
    CheckExternalEvents(cs5, 0x18DC);
    // CMP word ptr [BP + -0x10],0x0 (094C_18D8 / 0xAD98)
    Alu16.Sub(UInt16[SS, (ushort)(BP - 0x10)], 0x0);
    CheckExternalEvents(cs5, 0x18DE);
    // JNZ 0x0000:adb3 (094C_18DC / 0xAD9C)
    if(!ZeroFlag) {
      goto label_094C_18F3_0ADB3;
    }
    CheckExternalEvents(cs5, 0x18E2);
    // CMP byte ptr [BP + -0x8],0x0 (094C_18DE / 0xAD9E)
    Alu8.Sub(UInt8[SS, (ushort)(BP - 0x8)], 0x0);
    CheckExternalEvents(cs5, 0x18E4);
    // JZ 0x0000:adb3 (094C_18E2 / 0xADA2)
    if(ZeroFlag) {
      goto label_094C_18F3_0ADB3;
    }
    CheckExternalEvents(cs5, 0x18EA);
    // MOV byte ptr ES:[0xd33a],0x1 (094C_18E4 / 0xADA4)
    UInt8[ES, 0xD33A] = 0x1;
    CheckExternalEvents(cs5, 0x18F0);
    // MOV byte ptr ES:[0xd399],0x0 (094C_18EA / 0xADAA)
    UInt8[ES, 0xD399] = 0x0;
    CheckExternalEvents(cs5, 0x18F3);
    // JMP 0x0000:ae9b (094C_18F0 / 0xADB0)
    goto label_094C_19DB_0AE9B;
    label_094C_18F3_0ADB3:
    CheckExternalEvents(cs5, 0x18F9);
    // MOV byte ptr ES:[0xd33a],0x0 (094C_18F3 / 0xADB3)
    UInt8[ES, 0xD33A] = 0x0;
    CheckExternalEvents(cs5, 0x18FE);
    // CALLF 0x1000:7fe8 (094C_18F9 / 0xADB9)
    FarCall(cs5, 0x18FE, unknown_17C6_0388_17FE8);
    CheckExternalEvents(cs5, 0x1902);
    // MOV ES,word ptr [0x545c] (094C_18FE / 0xADBE)
    ES = UInt16[DS, 0x545C];
    CheckExternalEvents(cs5, 0x1908);
    // CMP byte ptr ES:[0xd310],0x0 (094C_1902 / 0xADC2)
    Alu8.Sub(UInt8[ES, 0xD310], 0x0);
    CheckExternalEvents(cs5, 0x190A);
    // JZ 0x0000:adcd (094C_1908 / 0xADC8)
    if(ZeroFlag) {
      goto label_094C_190D_0ADCD;
    }
    CheckExternalEvents(cs5, 0x190D);
    // JMP 0x0000:ae72 (094C_190A / 0xADCA)
    goto label_094C_19B2_0AE72;
    label_094C_190D_0ADCD:
    CheckExternalEvents(cs5, 0x1910);
    // MOV AX,0x172d (094C_190D / 0xADCD)
    AX = 0x172D;
    CheckExternalEvents(cs5, 0x1911);
    // PUSH DS (094C_1910 / 0xADD0)
    Stack.Push16(DS);
    CheckExternalEvents(cs5, 0x1912);
    // PUSH AX (094C_1911 / 0xADD1)
    Stack.Push16(AX);
    CheckExternalEvents(cs5, 0x1917);
    // CALLF 0x1000:8055 (094C_1912 / 0xADD2)
    FarCall(cs5, 0x1917, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs5, 0x191A);
    // ADD SP,0x4 (094C_1917 / 0xADD7)
    // SP += 0x4;
    SP = Alu16.Add(SP, 0x4);
    CheckExternalEvents(cs5, 0x191E);
    // MOV ES,word ptr [0x545c] (094C_191A / 0xADDA)
    ES = UInt16[DS, 0x545C];
    CheckExternalEvents(cs5, 0x1922);
    // MOV AL,ES:[0xd319] (094C_191E / 0xADDE)
    AL = UInt8[ES, 0xD319];
    CheckExternalEvents(cs5, 0x1923);
    // CBW  (094C_1922 / 0xADE2)
    AX = (ushort)((short)((sbyte)AL));
    CheckExternalEvents(cs5, 0x1925);
    // MOV BX,AX (094C_1923 / 0xADE3)
    BX = AX;
    CheckExternalEvents(cs5, 0x1927);
    // SHL BX,0x1 (094C_1925 / 0xADE5)
    BX <<= 0x1;
    CheckExternalEvents(cs5, 0x1929);
    // SHL BX,0x1 (094C_1927 / 0xADE7)
    // BX <<= 0x1;
    BX = Alu16.Shl(BX, 0x1);
    CheckExternalEvents(cs5, 0x192D);
    // MOV ES,word ptr [0x54a2] (094C_1929 / 0xADE9)
    ES = UInt16[DS, 0x54A2];
    CheckExternalEvents(cs5, 0x1932);
    // PUSH word ptr ES:[BX + 0x4e34] (094C_192D / 0xADED)
    Stack.Push16(UInt16[ES, (ushort)(BX + 0x4E34)]);
    CheckExternalEvents(cs5, 0x1937);
    // PUSH word ptr ES:[BX + 0x4e32] (094C_1932 / 0xADF2)
    Stack.Push16(UInt16[ES, (ushort)(BX + 0x4E32)]);
    CheckExternalEvents(cs5, 0x193C);
    // CALLF 0x1000:8055 (094C_1937 / 0xADF7)
    FarCall(cs5, 0x193C, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs5, 0x193F);
    // ADD SP,0x4 (094C_193C / 0xADFC)
    // SP += 0x4;
    SP = Alu16.Add(SP, 0x4);
    CheckExternalEvents(cs5, 0x1942);
    // MOV AX,0x1761 (094C_193F / 0xADFF)
    AX = 0x1761;
    CheckExternalEvents(cs5, 0x1943);
    // PUSH DS (094C_1942 / 0xAE02)
    Stack.Push16(DS);
    CheckExternalEvents(cs5, 0x1944);
    // PUSH AX (094C_1943 / 0xAE03)
    Stack.Push16(AX);
    CheckExternalEvents(cs5, 0x1949);
    // CALLF 0x1000:8055 (094C_1944 / 0xAE04)
    FarCall(cs5, 0x1949, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs5, 0x194C);
    // ADD SP,0x4 (094C_1949 / 0xAE09)
    // SP += 0x4;
    SP = Alu16.Add(SP, 0x4);
    CheckExternalEvents(cs5, 0x1951);
    // MOV word ptr [BP + -0x12],0x0 (094C_194C / 0xAE0C)
    UInt16[SS, (ushort)(BP - 0x12)] = 0x0;
    CheckExternalEvents(cs5, 0x1953);
    // JMP 0x0000:ae16 (094C_1951 / 0xAE11)
    goto label_094C_1956_0AE16;
    label_094C_1953_0AE13:
    CheckExternalEvents(cs5, 0x1956);
    // INC word ptr [BP + -0x12] (094C_1953 / 0xAE13)
    UInt16[SS, (ushort)(BP - 0x12)]++;
    label_094C_1956_0AE16:
    CheckExternalEvents(cs5, 0x195A);
    // CMP word ptr [BP + -0x12],0x8 (094C_1956 / 0xAE16)
    Alu16.Sub(UInt16[SS, (ushort)(BP - 0x12)], 0x8);
    CheckExternalEvents(cs5, 0x195C);
    // JGE 0x0000:ae9b (094C_195A / 0xAE1A)
    if(SignFlag == OverflowFlag) {
      goto label_094C_19DB_0AE9B;
    }
    CheckExternalEvents(cs5, 0x195F);
    // MOV SI,word ptr [BP + -0x12] (094C_195C / 0xAE1C)
    SI = UInt16[SS, (ushort)(BP - 0x12)];
    CheckExternalEvents(cs5, 0x1963);
    // CMP byte ptr [BP + SI + -0x8],0x0 (094C_195F / 0xAE1F)
    Alu8.Sub(UInt8[SS, (ushort)(BP + SI - 0x8)], 0x0);
    CheckExternalEvents(cs5, 0x1965);
    // JZ 0x0000:ae13 (094C_1963 / 0xAE23)
    if(ZeroFlag) {
      goto label_094C_1953_0AE13;
    }
    CheckExternalEvents(cs5, 0x1968);
    // DEC word ptr [BP + -0x10] (094C_1965 / 0xAE25)
    UInt16[SS, (ushort)(BP - 0x10)] = Alu16.Dec(UInt16[SS, (ushort)(BP - 0x10)]);
    CheckExternalEvents(cs5, 0x196A);
    // JNS 0x0000:ae13 (094C_1968 / 0xAE28)
    if(!SignFlag) {
      goto label_094C_1953_0AE13;
    }
    CheckExternalEvents(cs5, 0x196D);
    // MOV AX,0x1a (094C_196A / 0xAE2A)
    AX = 0x1A;
    CheckExternalEvents(cs5, 0x196F);
    // IMUL SI (094C_196D / 0xAE2D)
    int resImul094C_196D = Alu16.Imul((short)AX, (short)SI);
    AX = (ushort)(resImul094C_196D);
    DX = (ushort)(resImul094C_196D >> 16);
    CheckExternalEvents(cs5, 0x1971);
    // MOV BX,AX (094C_196F / 0xAE2F)
    BX = AX;
    CheckExternalEvents(cs5, 0x1975);
    // MOV ES,word ptr [0x545c] (094C_1971 / 0xAE31)
    ES = UInt16[DS, 0x545C];
    CheckExternalEvents(cs5, 0x197A);
    // MOV AL,byte ptr ES:[BX + 0xd398] (094C_1975 / 0xAE35)
    AL = UInt8[ES, (ushort)(BX + 0xD398)];
    CheckExternalEvents(cs5, 0x197C);
    // SUB AH,AH (094C_197A / 0xAE3A)
    AH -= AH;
    CheckExternalEvents(cs5, 0x197F);
    // AND AX,0x7 (094C_197C / 0xAE3C)
    // AX &= 0x7;
    AX = Alu16.And(AX, 0x7);
    CheckExternalEvents(cs5, 0x1982);
    // MOV word ptr [BP + -0xc],AX (094C_197F / 0xAE3F)
    UInt16[SS, (ushort)(BP - 0xC)] = AX;
    CheckExternalEvents(cs5, 0x1984);
    // MOV BX,AX (094C_1982 / 0xAE42)
    BX = AX;
    CheckExternalEvents(cs5, 0x1986);
    // MOV CL,0x4 (094C_1984 / 0xAE44)
    CL = 0x4;
    CheckExternalEvents(cs5, 0x1988);
    // SHL BX,CL (094C_1986 / 0xAE46)
    // BX <<= CL;
    BX = Alu16.Shl(BX, CL);
    CheckExternalEvents(cs5, 0x198C);
    // LEA AX,[BX + 0xa561] (094C_1988 / 0xAE48)
    AX = (ushort)(BX + 0xA561);
    CheckExternalEvents(cs5, 0x198F);
    // MOV DX,0x1ddc (094C_198C / 0xAE4C)
    DX = 0x1DDC;
    CheckExternalEvents(cs5, 0x1990);
    // PUSH DX (094C_198F / 0xAE4F)
    Stack.Push16(DX);
    CheckExternalEvents(cs5, 0x1991);
    // PUSH AX (094C_1990 / 0xAE50)
    Stack.Push16(AX);
    CheckExternalEvents(cs5, 0x1996);
    // CALLF 0x1000:8055 (094C_1991 / 0xAE51)
    FarCall(cs5, 0x1996, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs5, 0x1999);
    // ADD SP,0x4 (094C_1996 / 0xAE56)
    // SP += 0x4;
    SP = Alu16.Add(SP, 0x4);
    CheckExternalEvents(cs5, 0x199C);
    // MOV AX,0x178f (094C_1999 / 0xAE59)
    AX = 0x178F;
    CheckExternalEvents(cs5, 0x199D);
    // PUSH DS (094C_199C / 0xAE5C)
    Stack.Push16(DS);
    CheckExternalEvents(cs5, 0x199E);
    // PUSH AX (094C_199D / 0xAE5D)
    Stack.Push16(AX);
    CheckExternalEvents(cs5, 0x19A3);
    // CALLF 0x1000:8055 (094C_199E / 0xAE5E)
    FarCall(cs5, 0x19A3, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs5, 0x19A6);
    // ADD SP,0x4 (094C_19A3 / 0xAE63)
    // SP += 0x4;
    SP = Alu16.Add(SP, 0x4);
    CheckExternalEvents(cs5, 0x19AB);
    // CALLF 0x1000:8d29 (094C_19A6 / 0xAE66)
    FarCall(cs5, 0x19AB, unknown_18AD_0259_18D29);
    CheckExternalEvents(cs5, 0x19B0);
    // MOV word ptr [BP + -0x12],0x8 (094C_19AB / 0xAE6B)
    UInt16[SS, (ushort)(BP - 0x12)] = 0x8;
    CheckExternalEvents(cs5, 0x19B2);
    // JMP 0x0000:ae13 (094C_19B0 / 0xAE70)
    goto label_094C_1953_0AE13;
    label_094C_19B2_0AE72:
    CheckExternalEvents(cs5, 0x19B7);
    // CALLF 0x1000:aab0 (094C_19B2 / 0xAE72)
    FarCall(cs5, 0x19B7, unknown_19EF_0BC0_1AAB0);
    CheckExternalEvents(cs5, 0x19B9);
    // MOV BX,AX (094C_19B7 / 0xAE77)
    BX = AX;
    CheckExternalEvents(cs5, 0x19BC);
    // AND BX,0x7 (094C_19B9 / 0xAE79)
    BX &= 0x7;
    CheckExternalEvents(cs5, 0x19BE);
    // SHL BX,0x1 (094C_19BC / 0xAE7C)
    BX <<= 0x1;
    CheckExternalEvents(cs5, 0x19C0);
    // SHL BX,0x1 (094C_19BE / 0xAE7E)
    // BX <<= 0x1;
    BX = Alu16.Shl(BX, 0x1);
    CheckExternalEvents(cs5, 0x19C4);
    // MOV ES,word ptr [0x54a4] (094C_19C0 / 0xAE80)
    ES = UInt16[DS, 0x54A4];
    CheckExternalEvents(cs5, 0x19C9);
    // PUSH word ptr ES:[BX + 0x4e60] (094C_19C4 / 0xAE84)
    Stack.Push16(UInt16[ES, (ushort)(BX + 0x4E60)]);
    CheckExternalEvents(cs5, 0x19CE);
    // PUSH word ptr ES:[BX + 0x4e5e] (094C_19C9 / 0xAE89)
    Stack.Push16(UInt16[ES, (ushort)(BX + 0x4E5E)]);
    label_094C_19CE_0AE8E:
    CheckExternalEvents(cs5, 0x19D3);
    // CALLF 0x1000:8055 (094C_19CE / 0xAE8E)
    FarCall(cs5, 0x19D3, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs5, 0x19D6);
    // ADD SP,0x4 (094C_19D3 / 0xAE93)
    // SP += 0x4;
    SP = Alu16.Add(SP, 0x4);
    CheckExternalEvents(cs5, 0x19DB);
    // CALLF 0x1000:8d29 (094C_19D6 / 0xAE96)
    FarCall(cs5, 0x19DB, unknown_18AD_0259_18D29);
    label_094C_19DB_0AE9B:
    CheckExternalEvents(cs5, 0x19DC);
    // POP SI (094C_19DB / 0xAE9B)
    SI = Stack.Pop16();;
    CheckExternalEvents(cs5, 0x19DD);
    // POP DI (094C_19DC / 0xAE9C)
    DI = Stack.Pop16();;
    CheckExternalEvents(cs5, 0x19DF);
    // MOV SP,BP (094C_19DD / 0xAE9D)
    SP = BP;
    CheckExternalEvents(cs5, 0x19E0);
    // POP BP (094C_19DF / 0xAE9F)
    BP = Stack.Pop16();;
    CheckExternalEvents(cs5, 0x19E1);
    // RETF  (094C_19E0 / 0xAEA0)
    return FarRet();
  }
  ...
  public virtual Action split_0000_B046_0B046(int loadOffset) {
    ...
    int resImul0000_B05D = Alu16.Imul((short)AX, (short)UInt16[ES, 0x68]);
    ...
    Alu16.Sub(UInt16[SS, (ushort)(BP - 0x2)], 0x7D);
    ...
    int resImul0000_B09B = Alu16.Imul((short)AX, (short)UInt16[ES, 0x68]);
    ...
    int resImul0000_B0E3 = Alu16.Imul((short)AX, (short)UInt16[SS, (ushort)(BP - 0x2)]);
    ...
    int resImul0000_B123 = Alu16.Imul((short)AX, (short)UInt16[SS, (ushort)(BP - 0x2)]);
  ...
  public virtual Action unknown_094C_1D30_0B1F0(int loadOffset) {
    ...
    Alu16.Sub(UInt16[SS, (ushort)(BP - 0x2)], 0x2328);
  ...
  public virtual Action ghidra_guess_0000_C932_0C932(int loadOffset) {
    entrydispatcher:
    if(loadOffset != 0) {
      throw FailAsUntested("External goto not supported for this function.");
    }
    label_0000_C932_0C932:
    CheckExternalEvents(cs1, 0xC933);
    // PUSH BP (0000_C932 / 0xC932)
    Stack.Push16(BP);
    CheckExternalEvents(cs1, 0xC935);
    // MOV BP,SP (0000_C933 / 0xC933)
    BP = SP;
    CheckExternalEvents(cs1, 0xC938);
    // MOV AX,0x2 (0000_C935 / 0xC935)
    AX = 0x2;
    CheckExternalEvents(cs1, 0xC93D);
    // CALLF 0x1000:cecc (0000_C938 / 0xC938)
    FarCall(cs1, 0xC93D, unknown_19EF_2FDC_1CECC);
    CheckExternalEvents(cs1, 0xC940);
    // MOV AX,0x1 (0000_C93D / 0xC93D)
    AX = 0x1;
    CheckExternalEvents(cs1, 0xC941);
    // PUSH AX (0000_C940 / 0xC940)
    Stack.Push16(AX);
    CheckExternalEvents(cs1, 0xC946);
    // CALLF 0x0000:3fcc (0000_C941 / 0xC941)
    FarCall(cs1, 0xC946, unknown_0170_28CC_03FCC);
    CheckExternalEvents(cs1, 0xC949);
    // ADD SP,0x2 (0000_C946 / 0xC946)
    // SP += 0x2;
    SP = Alu16.Add(SP, 0x2);
    CheckExternalEvents(cs1, 0xC94C);
    // MOV AX,0x3e80 (0000_C949 / 0xC949)
    AX = 0x3E80;
    label_0000_C94C_0C94C:
    CheckExternalEvents(cs1, 0xC94D);
    // PUSH AX (0000_C94C / 0xC94C)
    Stack.Push16(AX);
    CheckExternalEvents(cs1, 0xC950);
    // MOV AX,0x42c3 (0000_C94D / 0xC94D)
    AX = 0x42C3;
    CheckExternalEvents(cs1, 0xC953);
    // MOV DX,0x1ddc (0000_C950 / 0xC950)
    DX = 0x1DDC;
    CheckExternalEvents(cs1, 0xC954);
    // PUSH DX (0000_C953 / 0xC953)
    Stack.Push16(DX);
    CheckExternalEvents(cs1, 0xC955);
    // PUSH AX (0000_C954 / 0xC954)
    Stack.Push16(AX);
    CheckExternalEvents(cs1, 0xC958);
    // MOV AX,0x1e92 (0000_C955 / 0xC955)
    AX = 0x1E92;
    CheckExternalEvents(cs1, 0xC959);
    // PUSH DS (0000_C958 / 0xC958)
    Stack.Push16(DS);
    CheckExternalEvents(cs1, 0xC95A);
    // PUSH AX (0000_C959 / 0xC959)
    Stack.Push16(AX);
    CheckExternalEvents(cs1, 0xC95F);
    // CALLF 0x1000:92e4 (0000_C95A / 0xC95A)
    FarCall(cs1, 0xC95F, unknown_18AD_0814_192E4);
    CheckExternalEvents(cs1, 0xC962);
    // ADD SP,0xa (0000_C95F / 0xC95F)
    // SP += 0xA;
    SP = Alu16.Add(SP, 0xA);
    CheckExternalEvents(cs1, 0xC967);
    // MOV word ptr [BP + -0x2],0x0 (0000_C962 / 0xC962)
    UInt16[SS, (ushort)(BP - 0x2)] = 0x0;
    label_0000_C967_0C967:
    CheckExternalEvents(cs1, 0xC96A);
    // MOV BX,word ptr [BP + -0x2] (0000_C967 / 0xC967)
    BX = UInt16[SS, (ushort)(BP - 0x2)];
    CheckExternalEvents(cs1, 0xC96E);
    // MOV ES,word ptr [0x54f4] (0000_C96A / 0xC96A)
    ES = UInt16[DS, 0x54F4];
    CheckExternalEvents(cs1, 0xC974);
    // MOV byte ptr ES:[BX + 0x244b],0x0 (0000_C96E / 0xC96E)
    UInt8[ES, (ushort)(BX + 0x244B)] = 0x0;
    CheckExternalEvents(cs1, 0xC977);
    // INC word ptr [BP + -0x2] (0000_C974 / 0xC974)
    UInt16[SS, (ushort)(BP - 0x2)]++;
    CheckExternalEvents(cs1, 0xC97C);
    // CMP word ptr [BP + -0x2],0x1e78 (0000_C977 / 0xC977)
    Alu16.Sub(UInt16[SS, (ushort)(BP - 0x2)], 0x1E78);
    CheckExternalEvents(cs1, 0xC97E);
    // JL 0x0000:c967 (0000_C97C / 0xC97C)
    if(SignFlag != OverflowFlag) {
      goto label_0000_C967_0C967;
    }
    CheckExternalEvents(cs1, 0xC982);
    // MOV ES,word ptr [0x54f6] (0000_C97E / 0xC97E)
    ES = UInt16[DS, 0x54F6];
    CheckExternalEvents(cs1, 0xC989);
    // MOV word ptr ES:[0xe48a],0x0 (0000_C982 / 0xC982)
    UInt16[ES, 0xE48A] = 0x0;
    CheckExternalEvents(cs1, 0xC98D);
    // MOV ES,word ptr [0x54f8] (0000_C989 / 0xC989)
    ES = UInt16[DS, 0x54F8];
    CheckExternalEvents(cs1, 0xC994);
    // MOV word ptr ES:[0x64],0x42f6 (0000_C98D / 0xC98D)
    UInt16[ES, 0x64] = 0x42F6;
    CheckExternalEvents(cs1, 0xC99B);
    // MOV word ptr ES:[0x66],0x1ddc (0000_C994 / 0xC994)
    UInt16[ES, 0x66] = 0x1DDC;
    label_0000_C99B_0C99B:
    CheckExternalEvents(cs1, 0xC9A0);
    // CALLF 0x0000:31fd (0000_C99B / 0xC99B)
    FarCall(cs1, 0xC9A0, unknown_0170_1AFD_031FD);
    CheckExternalEvents(cs1, 0xC9A4);
    // MOV ES,word ptr [0x54f6] (0000_C9A0 / 0xC9A0)
    ES = UInt16[DS, 0x54F6];
    CheckExternalEvents(cs1, 0xC9A9);
    // MOV BX,word ptr ES:[0xe48a] (0000_C9A4 / 0xC9A4)
    BX = UInt16[ES, 0xE48A];
    CheckExternalEvents(cs1, 0xC9AD);
    // MOV ES,word ptr [0x54f4] (0000_C9A9 / 0xC9A9)
    ES = UInt16[DS, 0x54F4];
    CheckExternalEvents(cs1, 0xC9B3);
    // CMP byte ptr ES:[BX + 0x42c3],0x49 (0000_C9AD / 0xC9AD)
    Alu8.Sub(UInt8[ES, (ushort)(BX + 0x42C3)], 0x49);
    CheckExternalEvents(cs1, 0xC9B5);
    // JL 0x0000:c99b (0000_C9B3 / 0xC9B3)
    if(SignFlag != OverflowFlag) {
      goto label_0000_C99B_0C99B;
    }
    CheckExternalEvents(cs1, 0xC9B8);
    // MOV AX,0xe (0000_C9B5 / 0xC9B5)
    AX = 0xE;
    CheckExternalEvents(cs1, 0xC9B9);
    // PUSH AX (0000_C9B8 / 0xC9B8)
    Stack.Push16(AX);
    CheckExternalEvents(cs1, 0xC9BE);
    // CALLF 0x0000:30bf (0000_C9B9 / 0xC9B9)
    FarCall(cs1, 0xC9BE, unknown_0170_19BF_030BF);
    CheckExternalEvents(cs1, 0xC9C1);
    // ADD SP,0x2 (0000_C9BE / 0xC9BE)
    // SP += 0x2;
    SP = Alu16.Add(SP, 0x2);
    CheckExternalEvents(cs1, 0xC9C4);
    // MOV AX,0x3c (0000_C9C1 / 0xC9C1)
    AX = 0x3C;
    CheckExternalEvents(cs1, 0xC9C5);
    // PUSH AX (0000_C9C4 / 0xC9C4)
    Stack.Push16(AX);
    CheckExternalEvents(cs1, 0xC9CA);
    // CALLF 0x1000:8ad6 (0000_C9C5 / 0xC9C5)
    FarCall(cs1, 0xC9CA, unknown_18AD_0006_18AD6);
    CheckExternalEvents(cs1, 0xC9CD);
    // ADD SP,0x2 (0000_C9CA / 0xC9CA)
    // SP += 0x2;
    SP = Alu16.Add(SP, 0x2);
    CheckExternalEvents(cs1, 0xC9D0);
    // MOV AX,0x4 (0000_C9CD / 0xC9CD)
    AX = 0x4;
    CheckExternalEvents(cs1, 0xC9D1);
    // PUSH AX (0000_C9D0 / 0xC9D0)
    Stack.Push16(AX);
    CheckExternalEvents(cs1, 0xC9D6);
    // CALLF 0x1000:7ee1 (0000_C9D1 / 0xC9D1)
    FarCall(cs1, 0xC9D6, unknown_17C6_0281_17EE1);
    CheckExternalEvents(cs1, 0xC9D9);
    // ADD SP,0x2 (0000_C9D6 / 0xC9D6)
    // SP += 0x2;
    SP = Alu16.Add(SP, 0x2);
    CheckExternalEvents(cs1, 0xC9DE);
    // CALLF 0x1000:7fe8 (0000_C9D9 / 0xC9D9)
    FarCall(cs1, 0xC9DE, unknown_17C6_0388_17FE8);
    CheckExternalEvents(cs1, 0xC9E0);
    // MOV SP,BP (0000_C9DE / 0xC9DE)
    SP = BP;
    CheckExternalEvents(cs1, 0xC9E1);
    // POP BP (0000_C9E0 / 0xC9E0)
    BP = Stack.Pop16();;
    CheckExternalEvents(cs1, 0xC9E2);
    // RETF  (0000_C9E1 / 0xC9E1)
    return FarRet();
  }
  ...
  public virtual Action ghidra_guess_0000_CCD4_0CCD4(int loadOffset) {
    ...
    int resImul0000_CCE7 = Alu16.Imul((short)AX, (short)UInt16[SS, (ushort)(BP - 0x4)]);
    ...
    int resImul0000_CD04 = Alu16.Imul((short)AX, (short)UInt16[SS, (ushort)(BP - 0x4)]);
    ...
    int resImul0000_CD24 = Alu16.Imul((short)AX, (short)UInt16[SS, (ushort)(BP - 0x4)]);
    ...
    Alu16.Sub(UInt16[SS, (ushort)(BP - 0x4)], 0x240);
    ...
    FarCall(cs1, 0xCE0A, unknown_19EF_0260_1A150);
    ...
    int resImul0000_CE68 = Alu16.Imul((short)AX, (short)UInt16[SS, (ushort)(BP - 0x4)]);
    ...
    Alu8.Sub(UInt8[ES, (ushort)(BX + 0xD34F)], 0x0);
  ...
  public virtual Action ghidra_guess_0000_CEB9_0CEB9(int loadOffset) {
    ...
    int resImul0000_CED7 = Alu16.Imul((short)AX, (short)UInt16[SS, (ushort)(BP - 0x4)]);
    ...
    Alu16.Sub(UInt16[SS, (ushort)(BP - 0x4)], 0x6);
    ...
    FarCall(cs1, 0xCF40, unknown_1643_17EA_17C1A);
  ...
  public virtual Action ghidra_guess_0000_CF78_0CF78(int loadOffset) {
    ...
    FarCall(cs1, 0xCF8E, unknown_1643_17EA_17C1A);
  ...
  public virtual Action ghidra_guess_0000_CFA2_0CFA2(int loadOffset) {
    ...
    Alu16.Sub(UInt16[SS, (ushort)(BP + 0x8)], 0x11);
    ...
    FarCall(cs1, 0xCFDA, unknown_1643_17EA_17C1A);
  ...
  public virtual Action ghidra_guess_0000_CFF7_0CFF7(int loadOffset) {
    ...
    Alu16.Sub(UInt16[SS, (ushort)(BP - 0x4)], 0xFA);
  ...
  public virtual Action ghidra_guess_0000_D07A_0D07A(int loadOffset) {
    ...
    Alu16.Sub(UInt16[SS, (ushort)(BP - 0x2)], 0x21);
    ...
    Alu8.Sub(UInt8[ES, (ushort)(BX + 0x45DE)], 0x0);
    ...
    FarCall(cs1, 0xD16C, unknown_1643_17EA_17C1A);
  ...
  public virtual Action ghidra_guess_0000_D17B_0D17B(int loadOffset) {
    ...
    FarCall(cs1, 0xD215, unknown_1643_17EA_17C1A);
  ...
  public virtual Action ghidra_guess_0000_D22A_0D22A(int loadOffset) {
    ...
    Alu16.Sub(UInt16[SS, (ushort)(BP + 0x6)], 0x48);
    ...
    throw FailAsUntested("Would have been a goto but label label_0000_D468_0D468 does not exist because no instruction was found there that belongs to a function.");
    label_0000_D276_0D276:
    CheckExternalEvents(cs1, 0xD27A);
    // CMP word ptr [BP + 0x8],0x38 (0000_D276 / 0xD276)
    Alu16.Sub(UInt16[SS, (ushort)(BP + 0x8)], 0x38);
    ...
    FarCall(cs1, 0xD2A5, unknown_1643_17EA_17C1A);
    ...
    FarCall(cs1, 0xD2BA, unknown_1643_17EA_17C1A);
    ...
    FarCall(cs1, 0xD2D1, unknown_1643_17EA_17C1A);
    ...
    Alu16.Sub(UInt16[SS, (ushort)(BP - 0x8)], 0x240);
    ...
    FarCall(cs1, 0xD387, unknown_19EF_0260_1A150);
    ...
    Alu16.Sub(UInt16[SS, (ushort)(BP - 0x8)], 0x300);
    ...
    // BX += UInt16[SS, (ushort)(BP - 0x4)];
    BX = Alu16.Add(BX, UInt16[SS, (ushort)(BP - 0x4)]);
  ...
  public virtual Action ghidra_guess_0000_D46C_0D46C(int loadOffset) {
    ...
    FarCall(cs1, 0xD486, unknown_1643_17EA_17C1A);
    ...
    Alu16.Sub(UInt16[SS, (ushort)(BP - 0x2)], 0x240);
    ...
    Alu16.Sub(UInt16[SS, (ushort)(BP - 0x2)], 0x300);
    ...
    FarCall(cs1, 0xD55D, unknown_19EF_0260_1A150);
    ...
    Alu16.Sub(UInt16[SS, (ushort)(BP - 0x2)], 0x40);
  ...
  public virtual Action ghidra_guess_0000_D5E3_0D5E3(int loadOffset) {
    ...
    FarCall(cs1, 0xD64C, unknown_0170_19BF_030BF);
