...
public partial class GeneratedOverrides : CSharpOverrideHelper {
  ...
  public virtual Action ghidra_guess_1000_0673_10673(int loadOffset) {
    ...
    CheckExternalEvents(cs8, 0x783);
    // MOV SI,AX (1000_0781 / 0x10781)
    SI = AX;
    CheckExternalEvents(cs8, 0x787);
    // MOV ES,word ptr [0x558e] (1000_0783 / 0x10783)
    ES = UInt16[DS, 0x558E];
    CheckExternalEvents(cs8, 0x789);
    // MOV AL,0x5 (1000_0787 / 0x10787)
    AL = 0x5;
    CheckExternalEvents(cs8, 0x78E);
    ...
    CheckExternalEvents(cs8, 0x801);
    // MOV ES,word ptr [0x55a8] (1000_07FD / 0x107FD)
    ES = UInt16[DS, 0x55A8];
    CheckExternalEvents(cs8, 0x806);
  ...
  public virtual Action ghidra_guess_1000_0934_10934(int loadOffset) {
    ...
    CheckExternalEvents(cs8, 0x997);
    // TEST AL,0x80 (1000_0995 / 0x10995)
    Alu8.And(AL, 0x80);
    CheckExternalEvents(cs8, 0x999);
    // JZ 0x1000:099e (1000_0997 / 0x10997)
    if(ZeroFlag) {
      goto label_1000_099E_1099E;
    }
    CheckExternalEvents(cs8, 0x99E);
    ...
    CheckExternalEvents(cs8, 0x9A2);
    // MOV ES,word ptr [0x5582] (1000_099E / 0x1099E)
    ES = UInt16[DS, 0x5582];
    CheckExternalEvents(cs8, 0x9A5);
    // MOV AX,word ptr [BP + -0xa] (1000_09A2 / 0x109A2)
    AX = UInt16[SS, (ushort)(BP - 0xA)];
    CheckExternalEvents(cs8, 0x9AA);
    ...
    CheckExternalEvents(cs8, 0x9BF);
    // MOV ES,word ptr [0x5584] (1000_09BB / 0x109BB)
    ES = UInt16[DS, 0x5584];
    CheckExternalEvents(cs8, 0x9C2);
    ...
    CheckExternalEvents(cs8, 0x9DB);
    // PUSH word ptr [BP + -0xc] (1000_09D8 / 0x109D8)
    Stack.Push16(UInt16[SS, (ushort)(BP - 0xC)]);
    CheckExternalEvents(cs8, 0x9DE);
    // PUSH word ptr [BP + -0xa] (1000_09DB / 0x109DB)
    Stack.Push16(UInt16[SS, (ushort)(BP - 0xA)]);
    CheckExternalEvents(cs8, 0x9DF);
    // PUSH CS (1000_09DE / 0x109DE)
    Stack.Push16(cs8);
    CheckExternalEvents(cs8, 0x9E2);
    // CALL 0x1000:05c5 (1000_09DF / 0x109DF)
    NearCall(cs8, 0x9E2, ghidra_guess_1000_05C5_105C5);
    CheckExternalEvents(cs8, 0x9E5);
    // ADD SP,0x4 (1000_09E2 / 0x109E2)
    // SP += 0x4;
    SP = Alu16.Add(SP, 0x4);
    CheckExternalEvents(cs8, 0x9E8);
    // MOV word ptr [BP + -0x8],AX (1000_09E5 / 0x109E5)
    UInt16[SS, (ushort)(BP - 0x8)] = AX;
    CheckExternalEvents(cs8, 0x9ED);
    // MOV word ptr [BP + -0xe],0x3 (1000_09E8 / 0x109E8)
    UInt16[SS, (ushort)(BP - 0xE)] = 0x3;
    CheckExternalEvents(cs8, 0x9F0);
    // MOV AX,0x11 (1000_09ED / 0x109ED)
    AX = 0x11;
    CheckExternalEvents(cs8, 0x9F3);
    ...
    CheckExternalEvents(cs8, 0xA3C);
    // MOV word ptr [BP + -0x2],AX (1000_0A39 / 0x10A39)
    UInt16[SS, (ushort)(BP - 0x2)] = AX;
    CheckExternalEvents(cs8, 0xA3F);
    // MOV AX,0x3 (1000_0A3C / 0x10A3C)
    AX = 0x3;
    CheckExternalEvents(cs8, 0xA42);
  ...
  public virtual Action ghidra_guess_1000_0A67_10A67(int loadOffset) {
    ...
    CheckExternalEvents(cs8, 0xA68);
    // PUSH BP (1000_0A67 / 0x10A67)
    Stack.Push16(BP);
    CheckExternalEvents(cs8, 0xA6A);
    // MOV BP,SP (1000_0A68 / 0x10A68)
    BP = SP;
    CheckExternalEvents(cs8, 0xA6D);
    // MOV AX,0x2 (1000_0A6A / 0x10A6A)
    AX = 0x2;
    CheckExternalEvents(cs8, 0xA72);
    // CALLF 0x1000:cecc (1000_0A6D / 0x10A6D)
    FarCall(cs8, 0xA72, unknown_19EF_2FDC_1CECC);
    CheckExternalEvents(cs8, 0xA76);
    // MOV ES,word ptr [0x55b0] (1000_0A72 / 0x10A72)
    ES = UInt16[DS, 0x55B0];
    CheckExternalEvents(cs8, 0xA7A);
    // MOV AX,ES:[0x4600] (1000_0A76 / 0x10A76)
    AX = UInt16[ES, 0x4600];
    CheckExternalEvents(cs8, 0xA7D);
    // MOV word ptr [BP + -0x2],AX (1000_0A7A / 0x10A7A)
    UInt16[SS, (ushort)(BP - 0x2)] = AX;
    CheckExternalEvents(cs8, 0xA80);
    // MOV AX,0x4 (1000_0A7D / 0x10A7D)
    AX = 0x4;
    CheckExternalEvents(cs8, 0xA81);
    // PUSH AX (1000_0A80 / 0x10A80)
    Stack.Push16(AX);
    CheckExternalEvents(cs8, 0xA86);
    // CALLF 0x1000:7ee1 (1000_0A81 / 0x10A81)
    FarCall(cs8, 0xA86, unknown_17C6_0281_17EE1);
    CheckExternalEvents(cs8, 0xA89);
    // ADD SP,0x2 (1000_0A86 / 0x10A86)
    // SP += 0x2;
    SP = Alu16.Add(SP, 0x2);
    CheckExternalEvents(cs8, 0xA8E);
    // CALLF 0x1000:7fe8 (1000_0A89 / 0x10A89)
    FarCall(cs8, 0xA8E, unknown_17C6_0388_17FE8);
    CheckExternalEvents(cs8, 0xA91);
    // PUSH word ptr [BP + 0x8] (1000_0A8E / 0x10A8E)
    Stack.Push16(UInt16[SS, (ushort)(BP + 0x8)]);
    CheckExternalEvents(cs8, 0xA94);
    // PUSH word ptr [BP + 0x6] (1000_0A91 / 0x10A91)
    Stack.Push16(UInt16[SS, (ushort)(BP + 0x6)]);
    CheckExternalEvents(cs8, 0xA99);
    // CALLF 0x1000:8055 (1000_0A94 / 0x10A94)
    FarCall(cs8, 0xA99, unknown_17C6_03F5_18055);
    CheckExternalEvents(cs8, 0xA9C);
    // ADD SP,0x4 (1000_0A99 / 0x10A99)
    // SP += 0x4;
    SP = Alu16.Add(SP, 0x4);
    CheckExternalEvents(cs8, 0xAA1);
    // CALLF 0x1000:8d29 (1000_0A9C / 0x10A9C)
    FarCall(cs8, 0xAA1, unknown_18AD_0259_18D29);
    CheckExternalEvents(cs8, 0xAA6);
    // CALLF 0x1000:7fe8 (1000_0AA1 / 0x10AA1)
    FarCall(cs8, 0xAA6, unknown_17C6_0388_17FE8);
    CheckExternalEvents(cs8, 0xAA9);
    // PUSH word ptr [BP + -0x2] (1000_0AA6 / 0x10AA6)
    Stack.Push16(UInt16[SS, (ushort)(BP - 0x2)]);
    CheckExternalEvents(cs8, 0xAAE);
    // CALLF 0x1000:7ee1 (1000_0AA9 / 0x10AA9)
    FarCall(cs8, 0xAAE, unknown_17C6_0281_17EE1);
    CheckExternalEvents(cs8, 0xAB0);
    // MOV SP,BP (1000_0AAE / 0x10AAE)
    SP = BP;
    CheckExternalEvents(cs8, 0xAB1);
    // POP BP (1000_0AB0 / 0x10AB0)
    BP = Stack.Pop16();;
    CheckExternalEvents(cs8, 0xAB2);
  ...
  public virtual Action ghidra_guess_1000_0B32_10B32(int loadOffset) {
    ...
    CheckExternalEvents(cs8, 0xB57);
    // MOV AX,word ptr [BP + 0x6] (1000_0B54 / 0x10B54)
    AX = UInt16[SS, (ushort)(BP + 0x6)];
    CheckExternalEvents(cs8, 0xB5A);
    // SUB AX,0x19 (1000_0B57 / 0x10B57)
    AX -= 0x19;
    CheckExternalEvents(cs8, 0xB5D);
    // CMP AX,0xa (1000_0B5A / 0x10B5A)
    Alu16.Sub(AX, 0xA);
    CheckExternalEvents(cs8, 0xB5F);
    ...
    CheckExternalEvents(cs8, 0xB61);
    // ADD AX,AX (1000_0B5F / 0x10B5F)
    // AX += AX;
    AX = Alu16.Add(AX, AX);
    CheckExternalEvents(cs8, 0xB62);
    // XCHG AX,BX (1000_0B61 / 0x10B61)
    (BX, AX) = (AX, BX);
    label_1000_0B62_10B62:
    CheckExternalEvents(cs8, 0xB67);
    ...
    uint targetAddress_1000_0B62 = (uint)(cs8 * 0x10 + UInt16[cs8, (ushort)(BX + 0x118E)] - cs1 * 0x10);
  ...
  public virtual Action split_1000_0BB4_10BB4(int loadOffset) {
    ...
    CheckExternalEvents(cs8, 0xBB7);
    // MOV AX,word ptr [BP + -0x2] (1000_0BB4 / 0x10BB4)
    AX = UInt16[SS, (ushort)(BP - 0x2)];
    CheckExternalEvents(cs8, 0xBB9);
    // MOV SP,BP (1000_0BB7 / 0x10BB7)
    SP = BP;
    CheckExternalEvents(cs8, 0xBBA);
    // POP BP (1000_0BB9 / 0x10BB9)
    BP = Stack.Pop16();;
    CheckExternalEvents(cs8, 0xBBB);
  ...
  public virtual Action ghidra_guess_1000_0BBB_10BBB(int loadOffset) {
    ...
    CheckExternalEvents(cs8, 0xBBC);
    // PUSH BP (1000_0BBB / 0x10BBB)
    Stack.Push16(BP);
    CheckExternalEvents(cs8, 0xBBE);
    // MOV BP,SP (1000_0BBC / 0x10BBC)
    BP = SP;
    CheckExternalEvents(cs8, 0xBC1);
    // MOV AX,0x12 (1000_0BBE / 0x10BBE)
    AX = 0x12;
    CheckExternalEvents(cs8, 0xBC6);
    // CALLF 0x1000:cecc (1000_0BC1 / 0x10BC1)
    FarCall(cs8, 0xBC6, unknown_19EF_2FDC_1CECC);
    CheckExternalEvents(cs8, 0xBC7);
    // PUSH SI (1000_0BC6 / 0x10BC6)
    Stack.Push16(SI);
    CheckExternalEvents(cs8, 0xBCC);
    // MOV word ptr [BP + -0x4],0x0 (1000_0BC7 / 0x10BC7)
    UInt16[SS, (ushort)(BP - 0x4)] = 0x0;
    CheckExternalEvents(cs8, 0xBD1);
    // MOV word ptr [BP + -0xa],0x1 (1000_0BCC / 0x10BCC)
    UInt16[SS, (ushort)(BP - 0xA)] = 0x1;
    CheckExternalEvents(cs8, 0xBD4);
    // MOV AX,0x7d (1000_0BD1 / 0x10BD1)
    AX = 0x7D;
    CheckExternalEvents(cs8, 0xBD7);
    ...
    uint targetAddress_1000_0CC5 = (uint)(cs8 * 0x10 + UInt16[cs8, (ushort)(BX + 0x15E2)] - cs1 * 0x10);
    ...
    CheckExternalEvents(cs8, 0xCCD);
    // MOV AX,0x7d (1000_0CCA / 0x10CCA)
    AX = 0x7D;
    CheckExternalEvents(cs8, 0xCD0);
    ...
    CheckExternalEvents(cs8, 0xCD2);
    // MOV BX,AX (1000_0CD0 / 0x10CD0)
    BX = AX;
    CheckExternalEvents(cs8, 0xCD6);
    // MOV ES,word ptr [0x558e] (1000_0CD2 / 0x10CD2)
    ES = UInt16[DS, 0x558E];
    CheckExternalEvents(cs8, 0xCDC);
    ...
    CheckExternalEvents(cs8, 0xCDE);
    // JMP 0x1000:0cae (1000_0CDC / 0x10CDC)
    goto label_1000_0CAE_10CAE;
    label_1000_0CDE_10CDE:
    CheckExternalEvents(cs8, 0xCE1);
    // MOV AX,0x7d (1000_0CDE / 0x10CDE)
    AX = 0x7D;
    CheckExternalEvents(cs8, 0xCE4);
    ...
    CheckExternalEvents(cs8, 0xCE6);
    // MOV BX,AX (1000_0CE4 / 0x10CE4)
    BX = AX;
    CheckExternalEvents(cs8, 0xCEA);
    // MOV ES,word ptr [0x558e] (1000_0CE6 / 0x10CE6)
    ES = UInt16[DS, 0x558E];
    CheckExternalEvents(cs8, 0xCF0);
    ...
    CheckExternalEvents(cs8, 0xCF2);
    // JMP 0x1000:0cae (1000_0CF0 / 0x10CF0)
    goto label_1000_0CAE_10CAE;
    label_1000_0CF2_10CF2:
    CheckExternalEvents(cs8, 0xCF5);
    // MOV AX,0x7d (1000_0CF2 / 0x10CF2)
    AX = 0x7D;
    CheckExternalEvents(cs8, 0xCF8);
    ...
    CheckExternalEvents(cs8, 0xCFA);
    // MOV BX,AX (1000_0CF8 / 0x10CF8)
    BX = AX;
    CheckExternalEvents(cs8, 0xCFE);
    // MOV ES,word ptr [0x558e] (1000_0CFA / 0x10CFA)
    ES = UInt16[DS, 0x558E];
    CheckExternalEvents(cs8, 0xD04);
